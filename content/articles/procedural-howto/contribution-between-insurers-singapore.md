---
title: "Contribution Between Insurers: When Multiple Policies Cover the Same Loss"
slug: "/procedural-howto/contribution-between-insurers-singapore"
...
meta_description: "Contribution is the principle by which, when two or more insurance policies cover the same loss, the insurers share the burden of the indemnity between..."
og_title: "Contribution Between Insurers: When Multiple Policies Cover the Same Loss"
og_description: "Contribution is the principle by which, when two or more insurance policies cover the same loss, the insurers share the burden of the indemnity between..."
---
...
**Practice 1: Map the cover stack.** For each loss type, identify which policies could respond. The map is part of the [annual 60-minute audit](/procedural-howto/business-insurance-audit-60-minutes-singapore).
...
1. The SME notifies each insurer.
2. Each insurer assesses whether its policy responds to the loss.
3. The insurers determine, through their internal coordination or through legal process, the contribution mechanic - rateable proportion, excess of, primary and non-contributory.
4. The combined response indemnifies the SME (up to the actual loss).
5. Any contribution disputes between insurers are typically resolved between them, with the SME indemnified in the meantime.
...
1. **No map of overlapping cover.** At a claim, the SME does not know which insurers to notify.

2. **Failing to notify all potentially-responsive insurers.** Risks a coverage challenge.

3. **Accepting "primary and non-contributory" in a contract** without confirming the SME's policy permits.

4. **Assuming "excess of" cover responds when primary cover is in dispute.** It typically does not.

5. **Different trigger basis** across overlapping covers (claims-made vs occurrence) producing unintended gaps.

6. **No register of contracts requiring primary-and-non-contributory wording.**

7. **No endorsement on policy** to reflect contractually-required primary-and-non-contributory status.

8. **Inconsistent definitions** across overlapping covers producing partial overlap with gaps.

9. **Insurer correspondence about contribution** ignored by SME.

10. **No coordinated claim file** when multiple insurers are involved.

### What This Means for Your Business

1. **Map the cover stack** for each loss type your business runs.

2. **Document primary-and-non-contributory requirements** in commercial contracts.

3. **Confirm policy endorsements** match the contractual wording requirements.

4. **At a claim, notify all potentially-responsive insurers.**

5. **Maintain a register of overlapping covers** in the seven-folder structure.

6. **Review the contribution clause** in each policy at every renewal.

7. **Coordinate the claim file** when multiple insurers are involved.

8. **Use the [60-minute audit](/procedural-howto/business-insurance-audit-60-minutes-singapore)** as the annual baseline.

### Questions to Ask Your Adviser

1. For our current cover stack, where do you see overlap between policies?
2. For our contracts requiring primary-and-non-contributory wording, are our policies endorsed to support it?
3. For each of our covers, what does the contribution clause say?
4. If we have a claim involving multiple potentially-responsive insurers, what is your support model?
5. Are there overlaps we should consciously remove (or consciously expand) at the next renewal?
