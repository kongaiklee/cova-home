---
title: "Why Email and WhatsApp Are the Worst Places to Store Business Insurance Policies"
slug: "/procedural-howto/email-whatsapp-business-insurance-storage-singapore"
category: "procedural-howto"
intent: "get-it-right"
topics: ["Work Injury (WICA)", "Cyber"]
industries: ["Retail / e-commerce"]
agencies: ["PDPC", "IRAS", "Singapore Statutes"]
article_number: 419
...
meta_description: "Insurance documents stored in personal email and WhatsApp fail exactly when needed. What that costs a Singapore business at a claim, and where they belong."
og_title: "Why Email and WhatsApp Are the Worst Places to Store Business Insurance Policies"
og_description: "Insurance documents stored in personal email and WhatsApp fail exactly when needed. What that costs a Singapore business at a claim, and where they belong."
---
...
The alternative is not exotic. It is the seven-folder structure documented in [the corporate insurance folder framework](/procedural-howto/corporate-insurance-folder-structure-singapore-sme), implemented in a single shared workspace with access control, version history, and a backup the organisation owns.

Three operational characteristics distinguish a compliant arrangement from a non-compliant one:

1. **Custody sits with the company, not the person.** The folders live on the company's shared drive or platform account. Two people have full access, at least one of whom is not the person most likely to leave. When a staff member departs, access is removed; the documents are not affected.
...
1. **Insurance documents on a staff member's personal mobile phone.** When the device is lost or replaced, the documents are unrecoverable.

2. **WhatsApp groups that include former staff.** Continued access to historical personal data after the purpose has ended is a Retention Limitation Obligation problem.
...
6. **Personal email as the policy-schedule store.** When the staff member leaves, their access leaves with them, and the company's documents leave with the access.

7. **Mixed personal and business correspondence in one channel.** PDPA Protection Obligation becomes harder to demonstrate when business and personal data are interleaved in an unstructured stream.

8. **No backup the organisation controls.** Personal cloud backups belong to the person, not to the company.

9. **Disappearing-messages enabled on the insurance chat.** Documents shared into the chat are erased on the timer; future retrieval is impossible.

10. **Assuming "we will sort this out when the time comes".** The time will be at a claim, a renewal, or a regulator request. Sorting it out under time pressure is the most expensive way to sort it out.

### What This Means for Your Business

1. **Stop sending or receiving insurance documents on WhatsApp and personal email from today.** Existing documents can be migrated in parallel; new ones should not enter the old channels.

2. **Decide where the documents will live.** The shared workspace must have access control, version history, and a backup that the organisation owns - the folder framework in [the corporate insurance folder framework](/procedural-howto/corporate-insurance-folder-structure-singapore-sme) sets out one workable structure.
...
6. **Audit annually.** A folder structure that is not reviewed becomes a folder structure that is silently obsolete.

7. **Brief the licensed adviser.** The next renewal goes to market from the new structure. The licensed adviser receives a clean data pack instead of a chain of forwarded emails.

### Questions to Ask Your Adviser

1. What is your standard format for sharing policy schedules, endorsements, and renewal documents - and can it be delivered to a shared workspace rather than a personal email?
2. For each policy you have placed for us, can you provide the complete document set for the last five years in a single export?
3. Have any of our documents been shared with any party outside our authorised contact list, and if so, can you provide an audit log?
4. When we change our primary insurance contact internally, what is your handover protocol?
5. If we lose access to our existing storage (departed staff, device loss), how much of our policy history can you reconstruct from your records?
