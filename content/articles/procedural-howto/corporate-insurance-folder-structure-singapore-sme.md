---
title: "Corporate Insurance Folder Structure Every Singapore SME Should Have"
slug: "/procedural-howto/corporate-insurance-folder-structure-singapore-sme"
category: "procedural-howto"
intent: "get-it-right"
topics: ["Work Injury (WICA)", "Public Liability", "Property & Fire"]
industries: []
agencies: ["Singapore Statutes", "IRAS", "PDPC"]
article_number: 418
...
- **Work Injury Compensation insurance** for employees doing manual work (and for non-manual employees within the MOM salary threshold), maintained under [WICA 2019](https://sso.agc.gov.sg/Act/WICA2019).
...
- **Motor third-party liability** for any company vehicle, under the [Motor Vehicles (Third-Party Risks and Compensation) Act 1960](https://sso.agc.gov.sg/Act/MVTPRCA1960).
...
- The **renewal-quote target date** (typically T-60: sixty days before expiry - see [the pre-renewal data preparation sprint](/procedural-howto/sme-pre-renewal-data-preparation-sprint-singapore) for the workflow that this date supports).
- The **premium-payment warranty deadline** (Singapore market practice on most non-life policies is sixty days from policy inception, per the General Insurance Association of Singapore / Singapore Insurance Brokers Association Premium Payment Framework - see [the framework explainer](/document-legal/premium-payment-framework)).
...
- **A renewal process** that turns the dates in the calendar into structured pre-renewal data submissions (see [the 90/60/30-day pre-renewal data preparation sprint](/procedural-howto/sme-pre-renewal-data-preparation-sprint-singapore)).
