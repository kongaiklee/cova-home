...
meta_description: "Stop the damage, photograph everything, keep the damaged items and notify the same day. What a Singapore flood or water claim actually rests on."
og_title: "How to File a Property All Risks Claim - Flood and Water Damage"
og_description: "Stop the damage, photograph everything, keep the damaged items and notify the same day. What a Singapore flood or water claim actually rests on."
---
...
- **Insured Perils** wording: covers only listed perils (fire, lightning, explosion, etc.). Flood is sometimes a named peril, sometimes optional, sometimes excluded.
- **Property All Risks (PAR) / All Risks** wording: covers any accidental loss not specifically excluded. Flood is **commonly excluded or sub-limited**, particularly for premises in flood-prone areas identified by [PUB](https://www.pub.gov.sg/Public/KeyInitiatives/Flood-Resilience).

Per GIA: "Offering a wider but more expensive cover is the all risks policy. Although it includes accidental damage, it can have a longer exclusion list as compared to an insured perils policy, despite being termed 'all risks'."

PUB's published flood-prone areas (per PUB's list updated 31 January 2024) have historically included parts of Bukit Timah (notably around Stevens Road and Balmoral Road), Tanjong Katong, Farrer Park / Jalan Besar around Rochor Canal, and the Commonwealth/Queenstown corridor. Insurers often surcharge or sub-limit these locations.
...
1. Does my PAR policy cover flood as standard, as an extension, or exclude it?
2. Is there a sub-limit or higher excess for flood losses?
3. Is my premises in a PUB-published flood-prone area, and how does that affect underwriting?
