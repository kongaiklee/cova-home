...
3. **Skipping the FSC question.** Per the [SCDF FSC framework](https://www.scdf.gov.sg/firecode), occupying premises that require an FSC without one is an offence and may also breach the policy "compliance with statutory requirements" warranty.
