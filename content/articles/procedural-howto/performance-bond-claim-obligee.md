---
title: "Performance Bond Claim Process from the Obligee Perspective: How Project Owners and Customers Claim"
slug: "/procedural-howto/performance-bond-claim-obligee"
...
meta_description: "A performance bond claim runs between three parties, not two, which is why it behaves unlike insurance. What a Singapore obligee must establish."
og_title: "Performance Bond Claim Process from the Obligee Perspective: How Project Owners and Customers Claim"
og_description: "A performance bond claim runs between three parties, not two, which is why it behaves unlike insurance. What a Singapore obligee must establish."
---
...
Performance bond claim handling is a specialised commercial process that combines contract administration, surety operational standards, and operational considerations. Understanding the obligee perspective explains both procurement-time considerations and claim-time discipline. Singapore surety operates within the [Insurance Act 1966](https://sso.agc.gov.sg/Act/IA1966) framework administered by [MAS](https://www.mas.gov.sg/) for surety lines; for construction conventions specifically, see [BCA framework](https://www1.bca.gov.sg/) and specific [HDB](https://www.hdb.gov.sg/) provisions for HDB-RRC bonds.
...
- Commercial conventions per [BCA](https://www1.bca.gov.sg/) framework
