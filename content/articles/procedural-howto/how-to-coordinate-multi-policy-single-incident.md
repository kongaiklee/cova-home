---
title: "How to Coordinate a Multi-Policy Insurance Response to a Single Incident"
slug: "/procedural-howto/how-to-coordinate-multi-policy-single-incident"
...
meta_description: "One Singapore fire can trigger property, business interruption and liability at once. How to run a multi-policy claim without the insurers pointing."
og_title: "How to Coordinate a Multi-Policy Insurance Response to a Single Incident"
og_description: "One Singapore fire can trigger property, business interruption and liability at once. How to run a multi-policy claim without the insurers pointing."
---
...
1. **Single-policy framing.** Operator notifies only "the" insurer (Property, typically); other cover lines uninformed; deadlines missed.

2. **WICA missed in non-fire scenarios.** Employee injury during cyber incident response; WICA implications overlooked.

3. **Cyber notification deadline missed.** 24-72 hour cyber requirement not met; cover affected.

4. **Reservation of rights not invoked.** Operator admits coverage; subsequently disputed by carrier.

5. **Adjusters arriving uncoordinated.** Multiple competing adjusters; conflicting positions documented.

6. **Forensic / expert work duplicated.** Multiple carriers commission separate forensics; cost inefficient and contradictions emerge.

7. **Subrogation cooperation gaps.** Operator settles with third party; carrier subrogation rights compromised; cover affected.

8. **Aggregate limit overlap missed.** Single event consumes shared aggregate; coverage gaps emerge.

9. **D&O / EPL employee data scenarios mishandled.** Employee data breach with both Cyber and EPL implications; coordination lacking.

10. **Documentation gaps.** Subsequent dispute on notifications, decisions, communications; cannot reconstruct.

### What This Means for Your Business

For Singapore SMEs maintaining multi-line insurance portfolios:

1. **Pre-incident: portfolio inventory** with all policies and notification deadlines documented.

2. **Pre-incident: incident response protocol** identifying who notifies which carrier in which scenarios.
...
6. **Inventory: all potentially-applicable policies** identified within 24 hours.

7. **Parallel notification: all relevant carriers** within respective deadlines.

8. **Reservation of rights: invoked appropriately** preserving position.

9. **Coordination: experts and adjusters managed** to avoid duplication.
...
1. For my current policy portfolio, do I have a complete inventory with notification deadlines documented?
2. For multi-policy scenarios likely in my industry (fire, cyber, contractor incidents, product issues), are response protocols documented?
3. For broker coordination role, is broker engaged on multi-line basis with capability to coordinate notifications?
4. For pre-engaged advisers (forensic, legal), do they have multi-line claim coordination experience?
5. For aggregate limit interactions across cover lines, are potential conflicts documented?
