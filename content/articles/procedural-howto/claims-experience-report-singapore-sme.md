---
title: "How to Request and Read Your Claims Experience Report: A Singapore SME's Practical Guide"
slug: "/procedural-howto/claims-experience-report-singapore-sme"
...
- The licensed adviser's market submission.
...
1. **Write to the licensed adviser or to the insurer directly**, identifying the policy by number, the policy years requested, and the format preferred.
2. **Wait 5-10 working days** for the report's preparation. Some insurers can produce within 48 hours; others take longer for older policy years or complex portfolios.
3. **Verify the report's coverage** - does it cover all the policy years requested, all the claims, and the current reserves on open claims?

The licensed adviser can request on the SME's behalf and is usually faster than direct request because of pre-existing communications channels.

For renewal cycles, the standard practice is to request the report at **T-90** (90 days before renewal) as part of the pre-renewal data assembly - see [how to brief your insurance adviser](/procedural-howto/how-to-brief-insurance-adviser-singapore).
...
The report typically covers a **five-year window**, which aligns with the [IRAS record-keeping requirement](https://www.iras.gov.sg/taxes/corporate-income-tax/basics-of-corporate-income-tax/record-keeping-requirements) and with standard underwriting practice.
...
Five-year patterns worth reviewing with the licensed adviser at renewal.
...
At the **T-60 brief** to the licensed adviser (see [how to brief your insurance adviser](/procedural-howto/how-to-brief-insurance-adviser-singapore)), the claims experience report is the primary loss data. The licensed adviser's market submission references the report directly.
...
The claims experience report belongs in the relevant policy-year folder under the [seven-folder document structure](/procedural-howto/corporate-insurance-folder-structure-singapore-sme), alongside the policy schedule and endorsements. Retention: at least five years per [IRAS record-keeping requirements](https://www.iras.gov.sg/taxes/corporate-income-tax/basics-of-corporate-income-tax/record-keeping-requirements).
...
1. **Not requesting the report until T-30.** The licensed adviser receives it too late to use in the renewal-quote process.

2. **Accepting the report without verification.** Insurer error in recording is common; verify against the SME's own records.

3. **Ignoring open claims in renewal planning.** The reserves are the uncertainty range.

4. **No comparison across policy years.** The patterns emerge from multi-year data.

5. **Sharing the report only with the incumbent insurer.** Alternative insurers need it for competitive quotes.

6. **No annotation of unusual claims.** A one-off catastrophic claim should be flagged with context.

7. **No subrogation tracking.** The recovered amount is invisible without it.

8. **Report retained for one renewal cycle only.** Five-year retention is the minimum.

9. **Personal data in claims descriptions not addressed for PDPA.** Underwriters may not need individual claimant names; check before sharing.

10. **No post-renewal review of the report.** The next year's report is the new baseline.

### What This Means for Your Business

1. **Request the claims experience report at T-90** at every renewal.

2. **Verify the report against your own claims records** within a week of receipt.

3. **Analyse the five-year patterns** before the licensed adviser brief.

4. **Use the report as the basis for renewal-term negotiation.**

5. **Address PDPA implications** of sharing the report with alternative insurers.

6. **Retain the report** in the seven-folder structure for at least five years.

7. **Track subrogation, deductibles, and open-claim aging** as part of the annual insurance review.

8. **Use the report in the [60-minute audit](/procedural-howto/business-insurance-audit-60-minutes-singapore)** as the loss-data input.

### Questions to Ask Your Adviser

1. Can you obtain our five-year claims experience report for every policy at our next renewal?
2. What is your standard format for the report and how do you cross-check accuracy?
3. For our open claims, what are the current reserves and what is the expected closure timeline?
4. Looking at the five-year patterns, where do you see opportunities to negotiate improved renewal terms?
5. For sharing the report with alternative insurers in a market exercise, what is your PDPA arrangement?
