---
title: "How to File a Data Breach Notification Under PDPA Part 6A: The PDPC 3-Day Clock"
slug: "/procedural-howto/pdpa-data-breach-notification-3-day-pdpc-singapore"
...
Under [section 48O](https://sso.agc.gov.sg/Act/PDPA2012) (in force from 1 February 2021), individuals may bring a private right of action for emotional distress or financial loss arising from a breach.

#### Published enforcement decisions

The PDPC publishes [enforcement decisions](https://www.pdpc.gov.sg/commissions-decisions) on a rolling basis. Recent decisions that contextualise the practice landscape include:
...
6. **Build the [PDPC notification portal](https://eservice.pdpc.gov.sg/case/db) into the response checklist.**

7. **Coordinate with [CSA's 2-hour CII reporting](https://sso.agc.gov.sg/Act/CA2018) regime** where the SME is a CII operator.
