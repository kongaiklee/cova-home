---
title: "How to Read Your Commercial Insurance Policy Schedule"
slug: "/procedural-howto/read-policy-schedule-singapore"
...
Words in *italics* or "quotation marks" in the Insuring Agreement are defined terms. "Bodily Injury," "Property Damage," "Occurrence," "Insured Event," "Premises," "Computer System," "Communicable Disease" - definitions narrow or widen cover. Read them.

**Step 3 - Read the Insuring Agreement / Coverage section.**
This is the actual promise. "We will indemnify the Insured against legal liability for damages arising from accidental Bodily Injury or Property Damage…" Note the **trigger** (occurrence-based vs. claims-made - most cyber and PI are claims-made; most PL and Property are occurrence).
...
**Step 6 - Read the Endorsements.**
Endorsements modify the base policy. Examples: additional insured, waiver of subrogation, increased limit on a particular peril, named-property exclusion, extended reporting period (cyber/PI). Endorsements override conflicting policy wording.

**Step 7 - Cross-reference against the Proposal Form.**
Singapore insurance is a contract of utmost good faith. Material non-disclosure in the proposal form can void the policy from inception. Re-read the proposal form copy you submitted; if any answer is no longer accurate, notify the insurer in writing immediately.
...
1. On my schedule, does the Named Insured exactly match my ACRA-registered name and UEN?
2. Are all operating locations and material assets listed?
3. What warranties and conditions precedent does my policy contain - and how do I evidence compliance?
4. Are sums insured on a reinstatement-cost basis, and when were they last benchmarked?
