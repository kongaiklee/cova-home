---
title: "How to Respond to a Non-Renewal Notice from a Commercial Insurer"
slug: "/procedural-howto/non-renewal-notice-commercial-insurer-singapore"
...
4. **Buying on price alone.** Taking the cheapest quote without comparing limits, sub-limits, excess and exclusions against the expiring cover.

5. **Letting cover lapse.** Failing to bind replacement cover before expiry and leaving a gap.
...
1. **Diary the expiry date** and treat it as a hard deadline.

2. **Request loss runs and the non-renewal reason in writing** within days of receipt.

3. **Brief your broker or adviser thoroughly** so the re-marketing submission is strong.

4. **Test the market broadly** - authorised direct insurers and the Lloyd's Asia Scheme.

5. **Compare quotes on cover, not just price.**
...
1. Have we diaried the policy expiry date and worked back a re-marketing timeline from it?
2. Have we requested our loss runs and the written reason for non-renewal from the insurer?
3. Is our re-marketing reaching a broad enough market, including the Lloyd's Asia Scheme where relevant?
4. Will replacement cover be bound before expiry, with the retroactive date preserved on any claims-made policies?
5. Does our business fall within FIDReC's small-business turnover ceiling, and if not, what dispute routes apply?
