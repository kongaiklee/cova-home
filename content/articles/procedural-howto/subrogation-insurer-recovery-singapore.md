---
title: "Subrogation: When Your Insurer Recovers from a Third Party"
slug: "/procedural-howto/subrogation-insurer-recovery-singapore"
...
meta_description: "Subrogation is the process by which an insurer, having indemnified the SME for a loss, steps into the SME's rights and pursues recovery against any third..."
og_title: "Subrogation: When Your Insurer Recovers from a Third Party"
og_description: "Subrogation is the process by which an insurer, having indemnified the SME for a loss, steps into the SME's rights and pursues recovery against any third..."
---
...
1. **Cooperate fully** with the insurer's recovery action - provide documents, witnesses, and statements.
2. **Preserve evidence** of the loss and of the responsible third party's involvement.
3. **Not prejudice the insurer's recovery rights** by waiving claims against third parties without consent.
4. **Account for any direct recovery** from a responsible third party (the recovery may need to be paid over to the insurer).
5. **Continue any limitation-period preservation** action (writs, demand letters) to prevent the claim against the third party from being time-barred.
...
1. **Signing contracts with waivers of subrogation** without checking the policy position.

2. **No notification to insurer** of material waivers.

3. **Direct settlement with a responsible third party** without insurer consent. May prejudice the insurer's position.

4. **Evidence not preserved** for the insurer's recovery action.

5. **Not maintaining the limitation-period clock** on the third-party claim.

6. **Misunderstanding the "made whole" principle.** The SME's residual loss may be entitled to first claim on a recovery.
...
10. **No coordination between the SME's solicitors and the insurer's** in any direct litigation.

### What This Means for Your Business

1. **Read every commercial contract** for waiver-of-subrogation clauses before signing.

2. **Notify the insurer** of any material waiver, ideally at policy renewal.

3. **Maintain a register** of contracts containing waivers in the seven-folder structure.

4. **Preserve evidence** of any loss and of the responsible third party's involvement.

5. **Cooperate fully** with the insurer's recovery action.

6. **Do not settle directly** with a responsible third party without insurer consent.

7. **Understand the "made whole" principle** for your specific policy wording.

8. **Coordinate solicitor engagement** between SME and insurer where the SME has direct counsel.

### Questions to Ask Your Adviser

1. For our current policies, what is the subrogation clause's position on waivers?
2. What is the "made whole" position - if a recovery is obtained, how does it flow between us and the insurer?
3. For our recent lease and supplier contracts, do they contain waivers of subrogation, and have they been notified?
4. If we suffer a loss that may have a third-party cause, what is the insurer's recovery support model?
5. For our deductible, does it form part of a subrogation recovery?
