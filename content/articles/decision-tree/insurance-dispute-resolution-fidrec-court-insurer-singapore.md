---
title: "When to Engage FIDReC, the Court, or Your Insurer Direct: A Singapore SME's Dispute-Resolution Decision Tree"
slug: "/decision-tree/insurance-dispute-resolution-fidrec-court-insurer-singapore"
...
meta_description: "Three routes exist for a Singapore insurance dispute and they escalate: the insurer's complaints process, then FIDReC, then the courts. When each fits."
og_title: "When to Engage FIDReC, the Court, or Your Insurer Direct: A Singapore SME's Dispute-Resolution Decision Tree"
og_description: "Three routes exist for a Singapore insurance dispute and they escalate: the insurer's complaints process, then FIDReC, then the courts. When each fits."
---

> **The Answer in 60 Seconds**
>
> Three routes exist for a Singapore SME's insurance-related dispute, in escalating order: (1) **Direct resolution with the insurer**, through the policy's complaints process and the insurer's published escalation contacts; (2) the **[Financial Industry Disputes Resolution Centre (FIDReC)](https://www.fidrec.com.sg/)**, whose [Terms of Reference v2.2 effective 1 July 2025](https://www.fidrec.com.sg/knowledgebase/article/KA-01324/en-us) extend dispute resolution to small businesses with group annual turnover at or below **S$1 million in each of the two preceding financial years**, with adjudication awards up to **S$150,000 per claim** (raised from S$100,000 on 1 July 2024) at a small-business fee of S$250 plus GST; and (3) **Court proceedings** - the Small Claims Tribunal (consumer matters under S$30,000), the State Courts (claims up to S$250,000), or the High Court (above S$250,000). The choice between routes depends on the dispute type, the amount at issue, whether the SME qualifies as a small business under FIDReC's threshold, and the time-sensitivity. This article sets out the decision logic, the criteria at each route, and what the SME should have ready before invoking any of them.
...
[FIDReC](https://www.fidrec.com.sg/) is Singapore's industry dispute-resolution scheme for the financial sector, established as an independent and impartial institution under [Part 6 of the Financial Services and Markets Act 2022](https://sso.agc.gov.sg/Act/FSMA2022). Its [Terms of Reference v2.2 effective 1 July 2025](https://www.fidrec.com.sg/knowledgebase/article/KA-01324/en-us) extended jurisdiction to small businesses and charities.
...
- **Mediation** - a facilitated discussion between the SME and the FI to reach a settled outcome. Mediation is voluntary and non-binding unless both parties agree to settle.
...
**Adjudication ceiling.** **S$150,000 per claim** for claims filed on or after 1 July 2024 (raised from the prior S$100,000 ceiling). Claims above this ceiling proceed to the courts, although the parties may agree to FIDReC's jurisdiction by mutual consent above the ceiling.
...
Where the matter falls outside FIDReC's jurisdiction (turnover above the small-business threshold, claim above S$150,000, or the SME elects not to use FIDReC), the court route applies.

**Small Claims Tribunal (SCT).** Under the [Small Claims Tribunals Act 1984](https://sso.agc.gov.sg/Act/SCTA1984), the SCT's jurisdiction is limited to consumer claims; commercial insurance disputes typically do not qualify. Where the SCT applies, the general claim limit is **S$20,000**, raised to **S$30,000** with the written consent of both parties, with strict subject-matter restrictions.
...
- Insurer has not yet provided a final position: continue direct resolution.

**Step 3: Is the claim within FIDReC's adjudication ceiling?**

- At or below S$150,000: FIDReC is operationally feasible.
- Above S$150,000: court is the formal route (unless the parties agree to extend FIDReC's jurisdiction).

**Step 4: Is the matter time-sensitive?**

- Hot dispute requiring urgent declaratory or injunctive relief: court.
- Standard dispute that can move at FIDReC's typical 3-6 month timeline: FIDReC.

**Step 5: Is the matter subject to FIDReC's exclusions?**

- Some matters (commercial decisions on premium pricing, underwriting acceptance) fall outside FIDReC's scope. The [FIDReC ToR](https://www.fidrec.com.sg/knowledgebase/article/KA-01324/en-us) sets out the exclusions.
...
The [document trail described in the document-trail article](/procedural-howto/document-trail-business-insurance-claim-singapore) is the natural source for these materials.
...
- The licensed adviser does not represent the SME in adversarial proceedings (FIDReC or court); the SME may engage solicitors for those routes.
...
| Route | Time to outcome | Approximate cost | Public record |
|---|---|---|---|
| Direct resolution | Days to weeks | Minimal (internal) | No |
| FIDReC mediation | 2-4 months | S$250+GST (small business) | No |
| FIDReC adjudication | 4-9 months | S$250+GST (small business) | Anonymised summaries published |
| State Court | 9-18 months | Filing fees + legal fees | Yes |
| High Court | 12-24+ months | Higher filing fees + legal fees | Yes |

The comparison is indicative; the actual time and cost depend on the dispute's complexity.

### Common Mistakes / What Goes Wrong

1. **Filing with FIDReC before insurer's final reply.** The 6-month clock starts only at the final reply.
...
4. **Selecting FIDReC when court is required.** Above the S$150,000 ceiling, FIDReC has no jurisdiction without consent.

5. **No documented insurer escalation.** The "final written position" requirement is the gate.

6. **No documentation of small-business turnover status.** FIDReC requires the threshold be evidenced.
...
8. **No solicitor engaged for court proceedings.** Self-representation in the High Court is feasible but rare.

9. **Treating FIDReC mediation as binding.** It is voluntary unless settled.
...
4. **For matters above S$150,000**, expect the court route and budget accordingly.
