---
title: "Opening a Logistics, Warehousing, or Freight Forwarding Operation in Singapore: Full Insurance Checklist"
slug: "/decision-tree/opening-logistics-warehousing-checklist"
...
Third-party liability cover is mandatory under the [Motor Vehicles (Third-Party Risks and Compensation) Act 1960](https://sso.agc.gov.sg/Act/MVTPRCA1960). Beyond that statutory minimum, **Goods in Transit** cover responds to cargo carried on the company's own vehicles — confirm it is in place where the operation moves its own freight.
