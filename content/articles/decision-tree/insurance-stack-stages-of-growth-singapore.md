---
title: "From Incorporation to Growth: How Your Insurance Stack Should Evolve"
slug: "/decision-tree/insurance-stack-stages-of-growth-singapore"
category: "decision-tree"
intent: "make-the-call"
topics: ["Work Injury (WICA)", "Motor & Fleet", "Professional Indemnity"]
industries: []
agencies: ["SINGSTAT", "IRAS", "Singapore Statutes", "MOM", "PDPC"]
article_number: 428
...
The seven-folder structure ([the corporate insurance folder framework](/procedural-howto/corporate-insurance-folder-structure-singapore-sme)) supports this by holding the policy schedule, the lease summary, the headcount snapshot, and the asset register in a single workspace where the licensed adviser can review them on each business event.

### Common Mistakes / What Goes Wrong

1. **Setting the PI retroactive date at policy inception rather than at incorporation.** Years of prior advice fall outside cover.

2. **Deferring key-person life past the founder's most-insurable decade.** Materially higher premium later.
...
6. **Sum-insured review deferred indefinitely.** Average clause applies at the next claim.

7. **Stack review tied to annual renewal rather than to business events.** Cover lags exposure.
...
1. **Identify your current life-cycle stage** against the four-stage map.

2. **Set up the PI retroactive date at the earliest defensible date** at the first policy.

3. **Consider key-person life on the founder at incorporation**, not at scaling.

4. **Bind BI and fire together** at the first premises lease.

5. **Take cyber cover when customer data starts to accumulate**, not when the first PDPA-relevant event arises.

6. **Review the D&O Side A/B/C structure** when appointing external directors.

7. **Trigger insurance review on business events**, not just on annual renewals.

8. **Run a sum-insured refresh at every stage transition** - the [60-minute audit](/procedural-howto/business-insurance-audit-60-minutes-singapore) is the natural cadence.

### Questions to Ask Your Adviser

1. Based on our current stage and trajectory, which covers will become relevant in the next 12 months that we do not currently hold?
2. For our existing claims-made covers, what is the retroactive date, and how would we extend it backwards if needed?
3. For our D&O cover (or proposed D&O cover), what is the Side A/B/C structure and what are the implications for the founder personally?
4. Which of our sums insured are due for refresh given changes in our revenue, headcount, or asset base since the last review?
5. When we cross the next stage threshold (new premises, new product, new director, new country), what is your protocol for triggering a stack review?
