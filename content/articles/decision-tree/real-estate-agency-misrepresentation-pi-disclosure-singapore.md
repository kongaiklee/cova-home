---
title: "Real Estate Agency Misrepresentation Cover and PI Disclosure Framework"
slug: "/decision-tree/real-estate-agency-misrepresentation-pi-disclosure-singapore"
...
**The property + identity combination:**
A breach exposing property addresses alongside client identities is particularly sensitive — pairing a home location with personal identification creates a physical-security risk for the client, not just a data-protection one.
...
10. **Cross-border transactions placed without confirming jurisdictional cover.**

### What This Means for Your Business

For Singapore real estate agency founders:

1. **The EA Licence and its mandatory PI are foundational.** You cannot operate without either.
...
5. **Document transactions thoroughly.** Contemporaneous records are the practical defence to a later claim.

6. **Coordinate agency and salesperson cover.** Confirm how individual RES liability is treated under the agency PI.

7. **For commercial, luxury, or cross-border work, use a broker who knows the segment.**

8. **Review annually.** The CEA framework and its conduct rules change.
...
1. For my agency profile (residential, commercial, luxury, cross-border), what PI limit and structure are appropriate?
2. Does my PI satisfy CEA's licensing condition, and does it cover both the agency and every salesperson?
3. Does my Cyber Liability include BEC / social-engineering-fraud cover and PDPA Section 26D notification costs?
4. How is individual RES liability addressed under my agency PI?
5. If my agency holds client funds, what Crime / Money provisions apply?
