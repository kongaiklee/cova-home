---
title: "SME Startup Decision Tree: Private Hire and Chauffeur Services - Foundational Insurance Procurement"
slug: "/decision-tree/private-hire-chauffeur-services"
...
meta_description: "Private hire, chauffeur and limousine operators carry passengers for reward. What that changes about Singapore motor cover, licensing and liability."
og_title: "SME Startup Decision Tree: Private Hire and Chauffeur Services - Foundational Insurance Procurement"
og_description: "Private hire, chauffeur and limousine operators carry passengers for reward. What that changes about Singapore motor cover, licensing and liability."
---

> **The Answer in 60 Seconds**
>
> Private hire and chauffeur service operators in Singapore - covering Private Hire Car (PHC) operations, chauffeur services, executive transport, limousine services, point-to-point booking platform operations, and specific specialty transport scope - operate under [Land Transport Authority (LTA)](https://www.lta.gov.sg/) framework with specific Private Hire Car licensing under [Road Traffic Act 1961](https://sso.agc.gov.sg/Act/RTA1961) and specific [Point-to-Point Passenger Transport Industry Act 2019](https://sso.agc.gov.sg/Act/PPPTIA2019). Foundational insurance includes substantial Commercial Motor with specific PHC provisions (mandatory under [Motor Vehicles (Third-Party Risks and Compensation) Act 1960](https://sso.agc.gov.sg/Act/MVTPRCA1960)), Public Liability with specific provisions for passenger scope, Professional Indemnity for specific advisory scope where applicable, EPL for driver employment relationships (where applicable), Cyber Liability for booking platform scope, and considerations on driver classification (employee vs contractor). Specific [Platform Workers Act 2024 (PWA)](https://sso.agc.gov.sg/Act/PWA2024) framework applies for platform operators effective January 2025.

### The Sourced Detail

The private hire and chauffeur services segment in Singapore has substantively evolved through Singapore's transport regulatory framework reforms - the [Point-to-Point Passenger Transport Industry Act 2019](https://sso.agc.gov.sg/Act/PPPTIA2019) consolidated taxi and PHC frameworks under unified LTA regulatory scope, and the [Platform Workers Act 2024](https://sso.agc.gov.sg/Act/PWA2024) created specific framework for platform-engaged workers. The combination of mandatory regulatory framework, substantial passenger scope, driver commercial relationships, and specific platform commercial scope creates a distinctive insurance profile.

#### Decision Point 1: Operational scope

The first decision point distinguishes operational scope.

**Private Hire Car (PHC) operator** - operator provides PHC services. Specific [LTA](https://www.lta.gov.sg/) Private Hire Car Driver's Vocational Licence (PDVL) scope for drivers, operational PHC vehicle scope, operational operational discipline.
...
**Employed drivers** - operator employs drivers under standard employer-employee relationship. Specific [WICA](https://www.mom.gov.sg/) framework, specific [Employment Act](https://sso.agc.gov.sg/Act/EmA1968) scope, operational considerations.

**Contracted drivers (PWA framework where applicable)** - operator engages drivers under commercial relationships. Specific [Platform Workers Act 2024](https://sso.agc.gov.sg/Act/PWA2024) framework where operator qualifies as platform operator. Operational operational scope.
...
**Commercial Motor with PHC provisions** - foundational and mandatory under the [Motor Vehicles (Third-Party Risks and Compensation) Act 1960](https://sso.agc.gov.sg/Act/MVTPRCA1960). Specific PHC provisions for passenger scope, operational considerations.
...
**[PWA-mandated work injury insurance](https://sso.agc.gov.sg/Act/PWA2024)** - for qualifying platform operators effective January 2025. Operational discipline.
...
For substantive private hire / chauffeur service operations, operational considerations includes specialist sector-aware broker engagement, specific [LTA-experienced](https://www.lta.gov.sg/) commercial counsel relationships, operational sophistication around driver management, operational PWA compliance discipline (where applicable), and commercial sensitivity around passenger commercial relationships.

### Common Mistakes / What Goes Wrong

1. **Inadequate Commercial Motor PHC provisions.**
2. **Inadequate Public Liability for passenger scope.**
3. **No driver classification (employee vs contractor).** Specific WICA / CPF / EPL exposure.
4. **No PWA-mandated work injury insurance for qualifying platform operators.**
5. **Inadequate Cyber Liability for booking platform scope.**
6. **No operational sophistication around PDVL discipline.** Specific LTA framework exposure.
7. **Inadequate fleet management discipline.**
8. **No specialist sector-aware broker engagement.**
9. **Inadequate D&O for incorporated structures.**
10. **No annual review covering LTA / PWA framework evolution.**
...
1. For my operational scope and driver commercial relationships, what cover scope is appropriate?
2. For Commercial Motor PHC provisions, what specific provisions apply?
3. For PWA scope (where applicable), what specific provisions apply?
4. For my customer commercial scope and platform commercial relationships, what specific provisions apply?
5. As LTA / PWA frameworks evolve, what cover evolution should I plan for?
