---
title: "Opening a Full-Service Restaurant in Singapore: Full Insurance Checklist"
slug: "/decision-tree/opening-full-service-restaurant-checklist"
category: "decision-tree"
intent: "make-the-call"
topics: ["Work Injury (WICA)", "Public Liability", "Property & Fire"]
industries: ["F&B"]
agencies: ["SCDF", "URA", "NEA", "SFA", "SPF", "Singapore Statutes", "MUIS"]
article_number: 122
...
6. **For liquor service, build operational discipline.** RSA training, ID checking, refusal protocols.

7. **Plan for delivery / off-site if applicable.** Different exposures require additional cover.

8. **Annual review with F&B-aware broker.** Industry-specific underwriting matters.
...
1. For my format (casual, fine dining, specialty), what PL/Product Liability limits are appropriate?
2. If I serve alcohol, what Liquor Liability extension is included and at what sub-limit?
3. For my equipment value and refrigeration dependency, is Equipment Breakdown structured appropriately?
4. How does my Cyber Liability address POS system data and PDPA exposure?
5. For delivery operations or off-site catering, what additional cover do I need?
