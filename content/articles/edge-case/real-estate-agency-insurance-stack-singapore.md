---
title: "Real Estate Agencies in Singapore: The Insurance Stack from Salesperson PI to Agency PL"
slug: "/edge-case/real-estate-agency-insurance-stack-singapore"
category: "edge-case"
intent: "beyond-the-basics"
topics: ["Work Injury (WICA)", "Public Liability", "Professional Indemnity"]
industries: ["Professional services", "Property"]
agencies: ["Singapore Statutes", "CEA", "PDPC", "SPF"]
article_number: 443
...
6. **Cyber cover with sub-limits inadequate** for the data volume held.

7. **No fidelity guarantee in place.** Employee dishonesty exposure rises with transaction volume.

8. **Marketing materials with unverifiable claims.** A misrepresentation in advertising flows into PI exposure.

9. **No regulatory-investigation cover under PI** - some PI wordings exclude CEA investigations.

10. **No documented training programme** on regulatory updates - the CPD obligation is on each salesperson.

### What This Means for Your Business

1. **Confirm the CEA licence is current** at every renewal cycle.

2. **Maintain a register of attached salespersons** matching the CEA Public Register.

3. **Audit the PI wording** for salesperson cover scope.

4. **Implement a PDPA programme** matching the data volume.

5. **Run AML/CFT desktop exercises** annually.

6. **Use the [60-minute insurance audit](/procedural-howto/business-insurance-audit-60-minutes-singapore)** as the annual baseline.

7. **Maintain the renewal calendar** documented in [the 12 insurance dates](/procedural-howto/12-insurance-renewal-dates-singapore-sme).

8. **Connect PI claims experience** to internal training - patterns inform mitigation.

### Questions to Ask Your Adviser

1. Does our PI cover include both employed and self-employed registered salespersons, and what are the per-individual / aggregate limits?
2. For regulatory investigations by CEA, what cover (if any) responds to defence costs?
3. For AML/CFT breaches, what cover responds to associated investigation costs (the regulatory fine itself is typically uninsurable)?
4. For our PDPA exposure, what is the cyber sub-limit for forensics and individual notification?
5. For fidelity guarantee, what is the limit and the conditions precedent (employee screening, internal controls)?
