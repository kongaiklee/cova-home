---
title: "Watchmaker, Watch Repair, and Specialty Watch Retail Insurance: Singapore Operator Framework"
slug: "/edge-case/watchmaker-watch-repair-specialty-retail"
category: "edge-case"
...
**Standard retail and customs.** [Singapore Customs](https://www.customs.gov.sg/) for imported watches; [GST / IRAS](https://www.iras.gov.sg/) registration; standard [ACRA](https://www.acra.gov.sg/) business registration.
...
**"Super-fake" production.** Some counterfeits are technically sophisticated, fooling all but specialist examination
**Movement transplants.** Genuine cases with replacement movements (or vice versa) creating partially-authentic items
**Re-cased / re-dialled pieces.** Originally genuine but subsequently modified
**Frankenwatches.** Assembled from period-correct parts but not original configurations
...
4. **Premises-attended vs unattended distinctions misunderstood.** Cover may differ materially between business hours (attended) and after-hours (unattended); shop-closed-during-day (lunch break) creates ambiguous case.

5. **Cash-in-transit / Specie transit gap.** Piece transit between branches uncovered; loss in transit triggers gap.

6. **Crime / Fidelity Guarantee undersized.** Insider theft over multiple years not adequately covered.

7. **Counterfeit sale exposure unaddressed.** Sale of subsequently-counterfeit-determined piece; specialty cover scope unclear.

8. **Authentication service liability unclear.** Authentication errors create direct exposure.

9. **PDPA / Cyber cover gap on high-net-worth client data.** Breach severity higher for HNW data.

10. **Multi-location aggregate limits.** Across branches, aggregate exposure not properly modelled.
...
2. **COG cover** for customer pieces in service / appraisal custody.

3. **Cash-in-Transit / Specie Transit** for piece transport.

4. **Property / Fire including security systems and watchmaking equipment.**

5. **PL for premises.**

6. **Crime / Fidelity Guarantee** sized for plausible insider exposure.

7. **Authentication / Misrepresentation cover** if applicable to operation.
...
1. For my stock portfolio (with named highest-value pieces), is Specie / JB cover at agreed values and is single-piece concentration addressed?
2. For customer pieces in custody (service, appraisal, authentication), is COG cover sized for realistic per-customer concentration?
3. For piece transit between branches / events / clients, is specialty transit cover in place?
4. For employee dishonesty exposure, is Crime / Fidelity sized for plausible multi-year insider scenarios?
5. For authentication service if offered, is professional liability scope clear and are protocols documented?
