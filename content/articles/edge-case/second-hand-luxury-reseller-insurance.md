---
title: "Second-Hand Luxury Reseller and Pre-Owned Goods Retail Insurance in Singapore (Watches, Bags, Sneakers, Designer Apparel)"
slug: "/edge-case/second-hand-luxury-reseller-insurance"
category: "edge-case"
...
1. **Standard SME Property relied on, with its low jewellery / watch sub-limit.**
2. **No All Risks Stock cover** for the high-value inventory.
3. **Crime / Money inadequate for the theft-target profile.**
4. **No PI for authentication services.** Authentication-dispute exposure left open.
5. **No Bailee / consignor goods cover.** Consignment exposure.
...
1. **All Risks Stock cover with declared inventory is foundational.** Standard SME Property is inadequate for luxury stock.

2. **Size Crime / Money to the theft-target profile.**

3. **Take PI for authentication services.**

4. **For consignment models, hold Bailee / consignor goods cover.**

5. **Invest in premises security.** It is both the operational and the underwriting foundation.

6. **Hold authentication discipline** - multi-point processes, documentation, and dispute resolution.

7. **For deep commodity expertise (watches versus bags versus sneakers), use a specialist broker.**
...
1. For my inventory value and commodity mix, what All Risks Stock cover is appropriate?
2. For theft target profile, how is Crime / Money structured?
3. For authentication services, what PI provisions and limits apply?
4. For consignment business model, what Bailee / consignor goods cover applies?
5. As I scale or add commodity categories, what insurance milestones should I plan for?
