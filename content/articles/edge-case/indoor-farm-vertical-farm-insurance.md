---
title: "Indoor Farm and Vertical Farm Insurance: Singapore Operator Framework"
slug: "/edge-case/indoor-farm-vertical-farm-insurance"
category: "edge-case"
...
**SFA farm licensing.** [Singapore Food Agency](https://www.sfa.gov.sg/food-farming) administers food farming licensing. [Farm licences](https://www.sfa.gov.sg/food-farming/licence-permit) include production scope, food safety standards, traceability requirements. [SFA "Singapore Food Story 2.0" framework](https://www.sfa.gov.sg/food-farming/sgfoodstory/30-by-30) sets food security strategy.

**Building / fire safety.** [BCA building code](https://www1.bca.gov.sg/) for warehouse / industrial space conversion to controlled-environment agriculture. [SCDF Fire Safety Act](https://sso.agc.gov.sg/Act/FSA1993) for fire safety; LED-array installations and high-density electrical infrastructure have specific considerations.

**Electrical / utilities.** [SP Group](https://www.spgroup.com.sg/) for electrical supply; large indoor farms have substantial connected load with specific supply considerations. Some operations qualify for industrial-tariff structures or have specific power-quality requirements.

**Water.** [PUB (Singapore's National Water Agency)](https://www.pub.gov.sg/) for water supply; hydroponic operations have specific water-use profiles.

**Workplace safety.** [Workplace Safety and Health Act 2006](https://sso.agc.gov.sg/Act/WSHA2006). [WICA 2019](https://sso.agc.gov.sg/Act/WICA2019) for employees.

**Food safety.** Production for human consumption falls within [Sale of Food Act 1973](https://sso.agc.gov.sg/Act/SFA1973) and SFA food safety framework.

**Pesticide / fertiliser regulation.** [National Parks Board (NParks)](https://www.nparks.gov.sg/) and SFA regulate pesticide and fertiliser use; indoor farms with closed environments have specific considerations.
...
1. **Crop-in-progress exposure unscoped.** BI covers revenue loss but indemnity period and trigger scope inadequate for growing-cycle realities.

2. **Utility extension absent or inadequate.** Power outage destroys crop; standard cover doesn't respond.

3. **Equipment Breakdown absent.** Chiller failure or pump failure cascading to crop loss; Property excludes mechanical breakdown.

4. **LED array under-declared.** Major capital component undervalued in Property declarations.

5. **Cyber cover scope limited to data.** OT / control system exposure unaddressed.

6. **Backup power inadequate.** UPS for control systems but no generator backup for sustained outage.

7. **Specialty seed and biological inventory undeclared.** Specialty seed lines, propagation cultures, breeding stock concentrate value undeclared.

8. **Product Liability scope inadequate for distribution channels.** Direct-to-consumer, retail, food service create different exposure profiles; cover not aligned.

9. **Working-at-height WICA exposure unmanaged.** Vertical configurations create fall-from-height exposure; protocols and equipment matter.

10. **Single-source equipment dependency.** Specialty equipment from single supplier; replacement timelines not factored into BI indemnity period.
...
2. **Confirm BCA / SCDF approvals** for current configuration.

3. **Property / Fire including all specialised infrastructure** at current replacement values. LED arrays, hydroponic systems, climate control, automation, fit-out.

4. **Equipment Breakdown / Machinery cover** for critical-function equipment.

5. **Utility extension** for power / water / connectivity scenarios.

6. **BI with crop-in-progress consideration** and growing-cycle-aware indemnity period.

7. **Specialty cover for crop-in-progress** where available.

8. **Public Liability and Product Liability** for premises and produce distribution.

9. **Cyber cover including OT / control system exposure.**
...
1. For my growing operation (cycle length, crop value, in-progress pipeline), is BI cover scope and indemnity period aligned with realistic crop-in-progress loss scenarios?
2. For utility dependency (power / water / connectivity), is utility extension cover in place and what are the conditions and exclusions?
3. For specialised infrastructure (LED arrays, hydroponics, climate control, automation), is Property cover at current replacement values and is Equipment Breakdown in place?
4. For control system / automation exposure, is Cyber cover scope extended to operational technology events?
5. For produce distribution channels (retail, F&B, direct consumer), is Product Liability scope aligned with each channel's exposure?
