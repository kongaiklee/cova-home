---
title: "Pawnshop and Pawnbroker Insurance: Singapore Operator Framework"
slug: "/edge-case/pawnshop-pawnbroker-insurance"
category: "edge-case"
...
1. **Pledge bailee limit sized for own-asset value.** Total pledge book exceeds limit; major theft / burglary creates uninsured shortfall.

2. **Single-customer concentration not declared.** High-net-worth customer pledge position not specifically declared; loss creates partial recovery.

3. **Standard property cover for precious metals.** Generic property cover insufficient for gold / jewellery / specialty watch theft; specie cover needed.

4. **Cash-in-transit cover gap.** Cash transit to bank uncovered; robbery during transit.
...
8. **Counterfeit pledge loss.** Pawnbroker loaned against pledge later determined counterfeit; loss not cover-eligible without specific scope.

9. **Unredeemed pledge sale liability.** Sale of pledge proceeds challenged by pledger or third party.

10. **PDPA cover gap on customer financial circumstance data.** Customer's financial situation is sensitive personal data.
...
2. **Pledge / Bailee cover** sized for pledge book aggregate plus per-customer concentration.

3. **Specialty / Specie cover for precious metals** with appropriate sub-limits.

4. **Cash-in-Safe and Cash-in-Transit cover.**

5. **Crime / Fidelity Guarantee** including armed robbery, burglary, employee theft.

6. **Property / Fire including security system value.**

7. **Public Liability for premises.**
