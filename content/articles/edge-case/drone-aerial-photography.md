---
title: "Drone Aerial Photography Insurance: What Singapore Operators Actually Need"
slug: "/edge-case/drone-aerial-photography"
category: "edge-case"
...
Per [CAAS's Unmanned Aircraft (UA) regulatory framework](https://www.caas.gov.sg/public-passengers/unmanned-aircraft), operators must comply with several layers of regulation:

1. **Registration.** UA above the de minimis weight threshold must be registered with CAAS. Verify the current threshold and registration process directly on the CAAS website before operating.

2. **Pilot licensing.** Commercial pilots and pilots of UA above the regulatory weight threshold typically require an Unmanned Aircraft Pilot Licence (UAPL). The licence is awarded after CAAS-approved training and assessment.

3. **Operator Permit.** Businesses operating UA commercially require a UA Operator Permit, granted on demonstration of competence, safety management, and (often) insurance.

4. **Activity Permits.** Specific operations - flying over crowds, in controlled airspace, beyond visual line of sight (BVLOS), at night, over restricted areas - require additional Activity Permits issued for the specific operation.

5. **Operational rules.** Maximum altitude, distance from airports, no-fly zones, height limits, daylight restrictions - set out in the Air Navigation Order and CAAS published guidance.

6. **No-fly zones.** Restricted areas around Changi Airport, Seletar Airport, Paya Lebar Airbase, military installations, key infrastructure. Real-time map at [oneap.caas.gov.sg](https://www.caas.gov.sg/) (Operating Drones Locator).
...
1. **Assuming general PL covers drone operations.** It almost certainly does not. Aviation exclusion is universal.
2. **Operating without a UAPL or Operator Permit.** Beyond the regulatory penalty, insurance often excludes uncovered operations - meaning the policy that exists doesn't respond.
3. **Flying in restricted airspace without an Activity Permit.** Breach of operating rules typically voids cover for that operation.
4. **No Hull cover on a S$10,000+ drone.** A propeller strike on a windy day is a write-off; without Hull, the operator absorbs the full loss.
5. **No CCC extension when filming client property.** Damage to the building being filmed is often excluded under standard UA Liability.
6. **No PI for service delivery.** A client who alleges the operator missed agreed deliverables can claim against PI; without it, the operator faces personal exposure.
7. **Single-job cover when multiple jobs are run weekly.** Some operators buy event-specific cover; for active commercial operators, an annual policy is far more economical and continuous.
8. **Hobbyist policies misapplied to commercial operations.** Some hobbyist drone insurance products are non-commercial only; using them for paid work voids cover.

### What This Means for Your Business

For a Singapore commercial drone operator, the typical cover stack:

1. **CAAS UAPL** for the pilot, **UA Operator Permit** for the business, **Activity Permits** for specific operations as required.

2. **UA Liability** with limit appropriate to the work - S$1M for wedding/event work, S$3M-S$5M for construction and infrastructure work, higher for specialist operations.

3. **Hull cover** on each drone in the fleet, including spares and payloads (cameras, gimbals, sensors). Consider in-transit cover if drones travel between sites.

4. **CCC extension** for client property exposure during operations.

5. **Professional Indemnity** if delivering creative or technical services.

6. **WICA** if employing pilots, ground crew, or assistants. Single-pilot owner-operators are not employees of themselves; partnerships and corporates should ensure WICA covers everyone in the operation.
...
1. Does my UA Liability policy cover all the specific operations I conduct - events, construction, BVLOS, night flying - or only standard daylight operations?
2. Is the limit of indemnity appropriate for my client mix, including any contractual minimums imposed by clients or venues?
3. Is Hull cover on a stated value or market value basis, and does it cover transit, storage, and accidental damage during operations?
4. Is the Care/Custody/Control extension included, and what is the sub-limit?
