---
title: "Specialty Alcohol and Wine Retailer Insurance: Singapore Operator Framework"
slug: "/edge-case/specialty-alcohol-wine-retailer-insurance"
category: "edge-case"
...
**Liquor licensing.** [Liquor Control (Supply and Consumption) Act 2015](https://sso.agc.gov.sg/Act/LCSCA2015) requires liquor licence for retail sale. Licence categories include retail-only and retail-plus-on-premise consumption. Operating hours, location, and consumption-on-premise terms vary by licence class.

**Excise duties.** [Singapore Customs](https://www.customs.gov.sg/) administers alcohol duties. Imported stock is duty-paid at point of entry (or held in licensed warehouse pending duty payment). Duty rates vary by alcohol type and strength.

**Food licensing if applicable.** [Singapore Food Agency (SFA)](https://www.sfa.gov.sg/) licensing if F&B accompanies alcohol retail (e.g., a wine bar with retail).

**Goods and Services Tax (GST).** [IRAS](https://www.iras.gov.sg/) GST registration where turnover exceeds threshold.
...
1. **Stock undervaluation through average-cost calculation.** Specialty stock concentration not reflected; co-insurance penalty triggered on claim.

2. **Allocation / rare items not separately declared.** Items requiring agreed value treated under general stock; underinsurance on specific high-value items.

3. **Climate control failure consequential damage uncovered.** Stock cover excludes temperature-excursion-related damage; major outage causes uninsured loss.

4. **Liquor Liability absent.** Standard PL relied on for alcohol-service claims; specific Liquor Liability needed.

5. **Theft cover conditions not met.** Alarm system inactive, security cameras inoperative; theft claim repudiated for non-compliance with cover conditions.

6. **Tasting events without specific cover scope.** Hosted events not within standard PL scope; injury during tasting uncovered.

7. **Off-site / pop-up events without scope extension.** Private client tastings and trade events outside premises-specific PL scope.

8. **Marine cargo gaps for specialty cargo.** Standard cargo cover doesn't address temperature-sensitive specialty wine cargo; reefer breakdown cover absent.

9. **Online cross-border shipment regulatory gap.** Sale to destinations with specific import restrictions creates regulatory and product-liability exposure.

10. **BI indemnity period too short.** 6-month BI inadequate for stock replacement of allocated / specialty inventory.
...
2. **Stock cover with current market value declarations.** Annually reviewed; high-value items separately declared with agreed values.

3. **Property / Fire including climate-control equipment.** Replacement values current.

4. **Theft / Burglary cover with appropriate sub-limits and condition compliance.**

5. **PL with tasting / event scope confirmed.**

6. **Liquor Liability for sale-related claims.**

7. **Marine Cargo for inbound stock with reefer / temperature-sensitivity provisions.**

8. **Business Interruption with realistic indemnity period.** Specialty stock replacement timelines.
...
1. For my stock portfolio (allocations, vintages, aged inventory), is stock cover declaration current with market values and are high-value items separately addressed?
2. For my premises configuration (climate control, security systems, alarm), do I meet the underwriter's conditions for stock cover and are temperature-excursion scenarios addressed?
3. For tasting events on premise and off-premise, is PL / Liquor Liability scope explicitly confirmed?
4. For inbound stock movement, is Marine Cargo cover scoped for specialty cargo including reefer breakdown?
5. For online retail and cross-border shipment, is regulatory and product-liability exposure scoped?
