---
title: "Pet Cafe or Animal Cafe in Singapore: What Insurance Do You Actually Need?"
slug: "/edge-case/pet-cafe-animal-cafe"
category: "edge-case"
...
3. **No customer waiver discipline.** Limits defensive position when claim arises.

4. **Allergy disclosure not prompted.** Customer with undisclosed allergy enters environment.

5. **F&B / animal area separation inadequate.** SFA inspection finding.

6. **No veterinary care arrangement.** AVS licence and operational requirement.

7. **Resident animal mortality not addressed.** Where high-value or replacement-cost meaningful.

8. **Brought-pet model without specific scope.** Customer-brought-dog cafes have different exposures.

9. **Zoonotic disease scope absent.** Rare but documented.

10. **Loss of Licence consideration absent.** Where regulatory dependency is acute.
...
3. **Build customer waiver and allergy disclosure protocols.**

4. **Build animal welfare and customer-handling protocols documented and trained.**

5. **Address F&B / animal area separation per SFA framework.**

6. **Carry Animal Mortality / Veterinary Expense cover** where resident animals have meaningful value or care obligation.

7. **Consider Loss of Licence cover** where AVS dependency is acute.

8. **Address Cyber / PDPA scope.**

9. **For dog cafes, address dog-specific elevated considerations.**
