---
title: "Does a Hotel-Keeper's Licence Require Insurance in Singapore?"
slug: "/licensing/hotel-keeper-licence-insurance-singapore"
category: "licensing"
...
>
> A [hotel-keeper's licence under the Hotels Act 1954](https://sso.agc.gov.sg/Act/HA1954) does not require you to buy any insurance policy. To run a hotel lawfully you need two things from the [Hotels Licensing Board](https://sso.agc.gov.sg/Act/HA1954): the premises must hold a **certificate of registration** under [section 5](https://sso.agc.gov.sg/Act/HA1954), and the person keeping or managing it must hold a **licence** under [section 7](https://sso.agc.gov.sg/Act/HA1954). Read the conditions for both in [sections 6 and 7](https://sso.agc.gov.sg/Act/HA1954) and in the [Hotels Licensing Regulations 1974](https://sso.agc.gov.sg/SL/HA1954-RG1), and you will not find an insurance requirement. The Board grants registration on structural suitability, sanitation, situation, and standard of accommodation, and grants the licence to a person of good character who is fit and proper. Cover is not in the test.
>
> The only insurance the law actually compels is separate from the licence. Your hotel employs people, and under [section 24 of the Work Injury Compensation Act 2019](https://sso.agc.gov.sg/Act/WICA2019) every employer must take out and maintain approved work-injury cover for its employees. Beyond that, property and fire, public liability for guest injury, business interruption, and cover tied to your duty over guests' property are sensible and often demanded by a landlord or a lender, but no statute ties them to the hotel-keeper's licence. So the honest answer is: the licence needs registration and a fit-and-proper manager, not a policy, and your staff need WICA cover whether or not you run a hotel.
...
Running a hotel is split into two permissions under the [Hotels Act 1954](https://sso.agc.gov.sg/Act/HA1954). First, no premises may be used as a hotel unless they are registered under [section 5](https://sso.agc.gov.sg/Act/HA1954), and the Board grants a certificate of registration only when it is satisfied on the five matters in [section 6](https://sso.agc.gov.sg/Act/HA1954): that the premises will not be run as a disorderly house, that they are structurally adapted for use as a hotel, that proper provision has been made for sanitation, that the situation is suitable, and that the standard of accommodation is adequate for the class. Second, [section 7](https://sso.agc.gov.sg/Act/HA1954) requires the person who keeps or manages the hotel to hold a valid licence, granted where the applicant is of good character and a fit and proper person, with the premises not run as a disorderly house. A "hotel-keeper" is defined in [section 2](https://sso.agc.gov.sg/Act/HA1954) as the person to whom that section 7 licence is granted.

Nowhere in those conditions does insurance appear. The Board may attach prescribed conditions and further case-by-case conditions to a licence under [section 7(3)](https://sso.agc.gov.sg/Act/HA1954), but the prescribed conditions live in the [Hotels Licensing Regulations 1974](https://sso.agc.gov.sg/SL/HA1954-RG1), and those Regulations govern signboards, guest registers, record-keeping, surveillance, and maintenance, not insurance. The Act's regulation-making power in [section 17](https://sso.agc.gov.sg/Act/HA1954) lets the Minister set conditions for licences, but the conditions actually made do not include a cover requirement. The honest reading is that the hotel-keeper's licence is silent on insurance.

#### The one definition of "hotel" that catches more operators than you think

The reach of the regime matters before you decide it does not apply to you. [Section 2](https://sso.agc.gov.sg/Act/HA1954) defines a "hotel" to include a boarding house, lodging house, and guesthouse: any building, not being a public institution, containing not less than four rooms or cubicles in which persons are harboured or lodged for hire and where domestic service is provided. A small guesthouse or a serviced lodging operation can sit squarely inside that definition. Operating an unregistered hotel, or keeping one without a section 7 licence, is an offence under [section 16](https://sso.agc.gov.sg/Act/HA1954). So the first question is registration and licensing, and only then does insurance follow as a separate commercial layer.
...
1. **Assuming the licence settles the insurance question.** The hotel-keeper's licence turns on registration, character, and premises standards under [sections 5 to 7](https://sso.agc.gov.sg/Act/HA1954). It says nothing about cover, so a clean licence is not evidence of any policy in place.

2. **Thinking a small guesthouse falls outside the regime.** The [section 2](https://sso.agc.gov.sg/Act/HA1954) definition catches premises with as few as four rooms where lodging is provided for hire with domestic service, so registration and licensing can apply well below "hotel" scale.

3. **Treating WICA as optional for a small operation.** The [section 24](https://sso.agc.gov.sg/Act/WICA2019) duty follows employment, and housekeeping and kitchen roles are manual work that sits inside it. Headcount, not the licence, decides the obligation.

4. **Confusing the hotel-keeper's duty over guests' property with a policy.** The Regulations require a [register of property left on the premises](https://sso.agc.gov.sg/SL/HA1954-RG1), but that record-keeping rule is not insurance. The liability behind it has to be funded separately.

5. **Letting the lease or loan, not the law, surprise you.** Property, fire, and public liability are usually mandated by the landlord or lender at a stated limit. Because the Hotels Act is silent, operators sometimes discover the real requirement only when the lease is enforced.

6. **Overlooking how registration and licence can be lost.** Under [section 8](https://sso.agc.gov.sg/Act/HA1954) the Board can suspend or cancel registration and the licence where a hotel is run improperly or kept in an insanitary condition, which is an operational risk no policy covers.

### What This Means for Your Business

If you are opening or renewing a hotel, separate the licence from the insurance and handle each on its own terms.

Treat the **licence** as a registration and character matter. Confirm the premises are registered under [section 5](https://sso.agc.gov.sg/Act/HA1954) and that the keeper or manager holds a current [section 7](https://sso.agc.gov.sg/Act/HA1954) licence, and keep the premises in the condition the Board inspects for, because [section 8](https://sso.agc.gov.sg/Act/HA1954) lets it act on an improperly run or insanitary hotel. None of this requires a policy, but all of it protects the right to trade.
...
1. Are our premises registered and is our hotel-keeper's licence current, and is the manager named on it the person actually keeping the hotel?
2. Does our staff roster, including housekeeping and kitchen roles, bring us within the WICA section 24 duty, and is every covered employee actually insured?
3. What do our lease and loan documents require for property, fire, and public liability cover, and at what limits, and do we meet them?
4. How does our business interruption cover respond if a fire or flood closes part or all of the hotel, and is the indemnity period long enough?
