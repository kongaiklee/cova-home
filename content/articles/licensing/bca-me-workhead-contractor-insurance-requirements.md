...
The ME Specific Registration Requirements ([ME SRR](https://file.go.gov.sg/bca-crs-srr-me.pdf)) define each ME workhead and the regulatory licences each requires. Examples:

- **ME01** - Air-Conditioning, Refrigeration & Ventilation Works
- **ME05** - Electrical Engineering. Per the ME SRR, applicants must employ a **Licensed Electrical Worker (LEW)** of the appropriate grade. Per the [Energy Market Authority](https://www.ema.gov.sg/regulations-licences/licences/worker-licences/electrical-engineers-licence), there are three classes of LEW: Electrician, Electrical Technician, and Electrical Engineer, with scope of work tied to voltage and approved load (45 kVA, 500 kVA, and above).
...
ME workheads are graded L1 (entry) to L6 (highest). Per the [BCA tendering limits page](https://www1.bca.gov.sg/procurement/pre-tender-stage/contractors-registration-system-crs/crs-tendering-limits), L6 firms can tender for unlimited-value specialist works; lower grades step down.
...
**WICA.** Mandatory for all manual workers and any employee earning ≤ S$2,600/month, per [MOM](https://www.mom.gov.sg/workplace-safety-and-health/work-injury-compensation). For ME firms doing site work at heights or in confined spaces, WICA premiums reflect the higher hazard rating.
