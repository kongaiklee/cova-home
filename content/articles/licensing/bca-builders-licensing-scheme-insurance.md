---
title: "BCA Builders Licensing Scheme: Insurance Requirements (Singapore)"
slug: "/licensing/bca-builders-licensing-scheme-insurance"
category: "licensing"
...
> Per the [BCA Builders Licensing Scheme page](https://www1.bca.gov.sg/safety-and-standards/applications-and-licenses/builders-licensing-scheme-bls/), the BLS itself does not mandate specific insurance policies as a licence condition. It mandates paid-up capital ("Class 1 General Builder: not less than $300,000 / Class 2 General Builder or Specialist Builder: not less than $25,000"), an Approved Person, a Technical Controller, and compliance with the Building Control Act. Insurance comes from *other* obligations: WICA from MOM, and project CAR/PL from your main-contract terms.

### The Sourced Detail

The BLS was introduced in 2009 under the Building Control (Amendment) Act 2007 to license builders carrying out construction works requiring approval by the Commissioner of Building Control. Per the [BCA BLS page](https://www1.bca.gov.sg/safety-and-standards/applications-and-licenses/builders-licensing-scheme-bls/), the scheme exists to ensure that builders meet minimum financial and technical requirements to carry out construction works safely.
...
1. "I'm a GB2 holder bidding for my first $5m project — does my main contract require project CAR in joint names, and what limit?"
2. "My Specialist Builder licence covers piling. If my sub-piler's worker is uninsured, what's my exposure under Section 13 of WICA 2019?"
3. "I hold both GB1 and SB(GS) licences — can a single annual WICA policy cover both UENs, or do I need separate ones?"
4. "Common Law Coverage isn't part of MOM's approved WICA wording — should I buy it as a separate policy or as a CAR add-on?"
5. "My BLS renewal is due — does my insurer need to refresh certificates of insurance for BCA, or is BLS document-only?"
