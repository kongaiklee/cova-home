---
title: "SFA Caterer Suspension Order: Restoring Operations After a Foodborne Illness Cluster"
slug: "/crisis/sfa-caterer-suspension-foodborne-illness"
category: "crisis"
...
meta_description: "Singapore's SFA has suspended operations over a gastroenteritis cluster linked to your food. What happens next, and what the first 48 hours decide."
og_title: "SFA Caterer Suspension Order: Restoring Operations After a Foodborne Illness Cluster"
og_description: "Singapore's SFA has suspended operations over a gastroenteritis cluster linked to your food. What happens next, and what the first 48 hours decide."
---
...
1. **Voluntary disclosure delayed.** SFA discovers from MOH cluster reports; less favourable positioning.

2. **Sample preservation gap.** Critical evidence for cause identification lost.

3. **Customer notification incomplete.** Affected consumers not warned; further illness occurs.

4. **Equipment audit superficial.** Same equipment continues to harbour contamination.

5. **Food handler retraining bypassed.** Same handlers, same practices, repeat occurrence.

6. **CPR cover absence.** Recall costs uninsured; substantial unrecovered loss.

7. **PL inadequate for foodborne illness.** Specific cover scope mismatch.

8. **Class action exposure unmanaged.** Multi-victim claim aggregated; substantial settlement exposure.

9. **Communication crisis amplification.** Specific media engagement amplifies brand harm.

10. **No FSMS root-cause analysis.** Symptoms addressed but root cause persists.
...
1. For our distribution scope, is standalone CPR cover or PL recall extension the right framework?
2. For FSMS, is current implementation likely to withstand SFA scrutiny across HACCP, training, equipment, records?
3. For customer relationships, are institutional contracts assessed for specific recall and indemnification obligations?
4. For crisis management, is pre-engaged consultant relationship in place (CPR insurer panel typically includes)?
5. For broker engagement, has CPR vs PL framework been specifically discussed for our exposure profile?
