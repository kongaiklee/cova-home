...
Per the [Insolvency, Restructuring and Dissolution Act 2018](https://sso.agc.gov.sg/Act/IRDA2018), creditors must file proofs of debt with the appointed liquidator or judicial manager. The process:
...
Per the [General Insurance Association of Singapore](https://gia.org.sg/) market structure, CBI is more common in larger enterprise insurance programmes than SME programmes. For SMEs with single-source critical supplier exposure, asking specifically about CBI in renewal discussions may be valuable.

**Cyber-related supplier failure:**
- If supplier failure was caused by cyber event affecting their operations, your Cyber policy's "Contingent BI" extension may respond (and notification to [MAS-licensed insurers](https://www.mas.gov.sg/regulation) typically within policy windows)
...
- Limited scenarios where alternative civil remedies apply within [Limitation Act 1959](https://sso.agc.gov.sg/Act/LA1959) periods
...
Per the [Insolvency, Restructuring and Dissolution Act 2018](https://sso.agc.gov.sg/Act/IRDA2018):
