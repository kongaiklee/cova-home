---
title: "Customer Receivership Mid-Receivable: The Trade Credit Insurance Notification Window"
slug: "/crisis/customer-receivership-trade-credit-claim"
category: "crisis"
...
**Marketlend Pty Ltd v QBE Insurance (Singapore) [2025] SGHC(I) 1** — Singapore's first TCI judgment (per [Article 355](#article-355) framework). Key precedent points:
...
**Section 219 mutual credit set-off.**
Where insolvent debtor and creditor have mutual dealings, set-off operates against the creditor's claim. For SMEs:
...
Where supply contract includes retention of title:
...
1. **TCI notification timing missed.** Specific 10-20 day insolvency window not tracked.

2. **Continued collection efforts.** Specific actions create preference recovery exposure.

3. **Documentation pack incomplete.** Specific evidence missing from claim submission.

4. **Retention of title gap.** Operational practice doesn't support legal position.

5. **Set-off claim not made.** IRDA Section 219 opportunity missed.

6. **Proof of claim filing late.** Specific deadline missed; reduced recovery position.

7. **"Disputed debt" assertion accepted.** Specific TCI defence not contested.

8. **Specific recovery rights misunderstanding.** TCI insurer assignment not coordinated.

9. **No funding bridge.** Cash flow impact during recovery not managed.

10. **Cross-border coordination gap.** Specific multi-jurisdiction recovery not coordinated.
...
1. For our TCI cover, what is specific insolvency notification timing per current policy?
2. For documentation, do we have specific evidence pack ready for prompt claim submission?
3. For retention of title, is operational practice (segregated stock, identifiable goods) aligned with contract terms?
4. For set-off, is IRDA Section 219 framework evaluated for material customer relationships?
