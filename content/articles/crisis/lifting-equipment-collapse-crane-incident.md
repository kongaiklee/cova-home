---
title: "Lifting Operation Failure: Crane Collapse, Lorry Crane Topple, Tower Crane Failure"
slug: "/crisis/lifting-equipment-collapse-crane-incident"
category: "crisis"
...
**Industry resource.** [Workplace Safety and Health Council](https://www.tal.sg/wshc/) publishes specific lifting safety guidance and learning bulletins.
...
**Third-party verification of repair.**
For damaged crane returned to service:
...
**Contractor-developer indemnity activation.**
...
**Failure 1 - Inadequate ground conditions.**
Mobile crane on insufficient outrigger pads, soft ground, undocumented buried services.

**Failure 2 - Wind speed exceedance.**
Operations continued beyond manufacturer's wind speed limits.

**Failure 3 - Overload.**
Lift exceeded chart capacity for radius / configuration.

**Failure 4 - Lifting plan deficiency.**
Inadequate planning for specific lift; supervisor not present; signal man inadequate.

**Failure 5 - Maintenance lapse.**
Hydraulic failure, brake failure, structural fatigue not detected by routine inspection.

**Failure 6 - Operator competency.**
Operator below required certification level for crane class.

**Failure 7 - Counterweight / configuration error.**
Crane not configured per manufacturer specification for the lift.

#### MOM Learning Reports as predictive resource

[MOM publishes Learning Reports](https://www.mom.gov.sg/) for serious workplace incidents - anonymised post-investigation summaries of:
- What happened
- Why it happened
...
1. **Lifting operations not stopped across all sites.** Same ACC continues operating; inconsistent risk profile.

2. **Lifting plan not preserved.** Critical evidence missing for investigation.

3. **Crane logbook gap.** Maintenance and defect history incomplete.

4. **ACC status suspension surprise.** Commercial implications underappreciated.

5. **CAR cover misinterpretation.** Crane treated as "construction plant" vs "permanent" inconsistently with policy definitions.

6. **Plant and equipment cover gap.** Hired crane without owner/hirer cover coordination.

7. **Third-party liability insufficient.** Sub-limits inadequate for severe scenarios.

8. **Sub-contractor liability cascade.** Indemnification chain not coordinated.

9. **D&O notification delayed.** Claims-made cover compromised.

10. **Repair without third-party verification.** MOM clearance not obtained before resumption.

### What This Means for Your Business

For Singapore SMEs in construction, marine, manufacturing with lifting operations:

1. **ACC compliance** - current designation, ACO and LS framework operational.

2. **Lifting plan discipline** - documented for every non-routine lift.

3. **Maintenance program** - daily, weekly, monthly, annual per manufacturer schedule.

4. **Operator competency** - current certifications, refreshers, sector-specific.

5. **Wind / weather protocol** - operational limits, monitoring, decision authority.

6. **Insurance coordination** - CAR, plant, third-party, WICA, D&O, PI.

7. **Sub-contractor management** - flow-down of lifting requirements.

8. **Incident response plan** - specific to lifting failure scenarios.

9. **Documentation discipline** - lifting plans, logbooks, maintenance records preserved.

10. **MOM Learning Reports** - periodic review and integration into training.
...
1. For ACC compliance, is current designation reviewed and is ACO / LS / operator framework operationally compliant?
2. For lifting plans, is documentation discipline in place for non-routine lifts?
3. For insurance, is crane treated consistently across CAR, plant, and third-party covers?
4. For sub-contractor management, are lifting requirements flowed down with appropriate insurance evidence?
5. For incident response, is specific lifting failure scenario addressed in protocol?
