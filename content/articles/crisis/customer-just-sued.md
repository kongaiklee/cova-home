...
An alternative to a Writ for certain types of proceedings (e.g. seeking specific declarations, injunctions). Time limits depend on the application type.
...
- **Contract and tort:** 6 years from accrual ([Limitation Act 1959 Section 6](https://sso.agc.gov.sg/Act/LA1959))
