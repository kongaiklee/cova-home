---
title: "CEA Real Estate Salesperson 2026 Framework Changes: What Singapore Real Estate SMEs Need to Know"
slug: "/regulatory-change/cea-res-2026-changes"
...
Per the [Estate Agents Act 2010](https://sso.agc.gov.sg/Act/EAA2010):
...
- Specific commercial conduct standards
- Specific consumer protection provisions

**CEA administration:**

Per [CEA framework](https://www.cea.gov.sg/):
...
- Higher for high-end / commercial property operations
...
- Specific specialised operational scope
...
1. **Estate agency licensing or RES registration gaps.**
2. **CPD compliance gaps.**
3. **PI inadequate for transaction values.**
4. **No BEC awareness / Cyber.** Specific high-frequency exposure.
5. **No consumer disclosure compliance.**
6. **No commission transparency.** Specific consumer protection gap.
7. **RES misclassification (employee vs contractor).**
8. **No transaction documentation discipline.**
9. **No advertising standards compliance.**
...
1. **CEA framework compliance is foundational.** Specific licensing and registration.

2. **CPD compliance for RES.** Direct compliance requirement.

3. **Comprehensive PI matched to transaction values.**

4. **Comprehensive Cyber with BEC.** Specific high-frequency exposure category.

5. **Specific consumer disclosure compliance.** Specific framework requirement.

6. **Specific commission transparency.** Specific commercial standard.

7. **For commercial complexity (commercial real estate, luxury, foreign buyers), specialist advisory.**

8. **Annual review covering framework evolution.** Evolving framework.
...
1. For my estate agency operations, what specific PI limits apply?
2. How does my Cyber Liability address BEC for real estate transactions?
3. For RES classification, what specific employee vs contractor considerations apply?
4. For commercial complexity (commercial, luxury, specialty), what specialised cover applies?
