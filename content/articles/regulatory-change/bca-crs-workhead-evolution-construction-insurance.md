---
title: "BCA Contractors Registration System Evolution 2024-2026: What Singapore Construction SMEs Need to Know"
...
**7 June 2024 circular: track record and paid-up capital thresholds raised.** BCA's circular set out the revised minimums for track record (TR) and paid-up capital (PUC) across workheads. The general direction was upward, particularly at higher grades. The current consolidated requirements are in the CRS Guidelines (September 2025) at [www1.bca.gov.sg/docs/default-source/docs-corp-procurement/registration_guidelines.pdf](https://www1.bca.gov.sg/docs/default-source/docs-corp-procurement/registration_guidelines.pdf).
...
[BCA CRS landing page](https://www1.bca.gov.sg/procurement/pre-tender-stage/contractors-registration-system-crs).

[CRS Guidelines (September 2025)](https://www1.bca.gov.sg/docs/default-source/docs-corp-procurement/registration_guidelines.pdf).

[CW Specific Registration Requirements (August 2024)](https://file.go.gov.sg/bca-crs-srr-cw.pdf).

[CR Specific Registration Requirements (May 2025)](https://file.go.gov.sg/bca-crs-srr-cr.pdf).

[Circular on the expansion of the CRS to a nation-wide registry (7 June 2024)](https://www1.bca.gov.sg/docs/default-source/docs-corp-news-and-publications/circulars/circular-on-the-expansion-of-the-crs-to-a-nation-wide-registry.pdf).

Application portal: eBACS at [www.bca.gov.sg/eBACS](https://www.bca.gov.sg/eBACS).
