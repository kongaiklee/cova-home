---
title: "The Singapore Convention on Mediation Act 2020: Cross-Border Dispute Resolution for SMEs"
slug: "/regulatory-change/singapore-convention-mediation-act-2020-cross-border-sme"
...
For Singapore, the [Mediation Act 2017 (MA2017)](https://sso.agc.gov.sg/Act/MA2017) governs domestic mediation; the [SCMA2020](https://sso.agc.gov.sg/Act/SCMA2020) provides the cross-border framework under the Convention.
...
- **Aligns with the [Mediation Act 2017](https://sso.agc.gov.sg/Act/MA2017)** for domestic mediation matters.
...
**3. Mediator selection.** The Singapore International Mediation Centre (SIMC) and other accredited bodies maintain panels of mediators; the SME's licensed adviser may have view on appropriate mediators for specific dispute types.

#### Practical steps

For an SME considering cross-border mediation:

1. **Confirm Convention applicability** - is the counterparty in a signatory state? Are the substantive requirements met?
2. **Select a mediator** - typically from an accredited panel.
3. **Document the mediation framework** - the mediation rules, the confidentiality framework, the costs allocation.
4. **Coordinate with the insurer** - if the SME's insurance cover engages the matter.
5. **Document the settlement** - in writing, meeting the Convention's form requirements.
...
1. **Not knowing the Convention exists.** Mediation undervalued as a cross-border tool.

2. **Mediating without checking Convention applicability.** Settlement may not be enforceable in the counterparty's jurisdiction.

3. **Counterparty in non-signatory state.** The Convention does not apply; enforcement must rely on local law.

4. **No insurer coordination** for matters within insurance cover.

5. **Mediation framework not documented** - mediation rules, costs, confidentiality.

6. **Settlement not in writing or not meeting Convention requirements.**

7. **Mediator without appropriate accreditation** for cross-border matters.

8. **No legal review of the settlement** before signing.

9. **Cross-border tax implications of settlement** not assessed.

10. **No coordination with parallel litigation** if litigation was commenced before mediation.

### What This Means for Your Business

1. **Add mediation to the dispute-resolution toolbox** alongside litigation and arbitration.

2. **Confirm Convention applicability** in cross-border commercial agreements.

3. **Use Singapore-based mediation infrastructure** where appropriate.

4. **Coordinate with insurers** for matters within cover.

5. **Document the mediation framework** properly.

6. **Engage legal review** of the settlement before signing.

7. **For dispute-resolution clauses in contracts**, consider tiered clauses (negotiation -> mediation -> arbitration/litigation).

8. **Track the Convention's signatory list** for counterparties.

### Questions to Ask Your Adviser

1. For our existing commercial covers, do they include legal-cost cover for mediation?
2. For a dispute involving a Convention-signatory counterparty, what is the standard support model?
3. For settlement-related cover (D&O / PI), what is the insurer's consent requirement?
4. For mediation-friendly contract clauses, what is your recommended framework?
5. For matters that may proceed beyond mediation to arbitration or litigation, how does the cover respond?
...
- [Singapore SaaS to US Customers: Data Residency, IP Indemnity, and Litigation Exposure](/cross-border/singapore-saas-us-customers-data-ip-litigation)
