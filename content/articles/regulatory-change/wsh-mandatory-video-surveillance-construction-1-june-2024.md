---
title: "WSH Mandatory Video Surveillance for Construction (S$5m+) Effective 1 June 2024: CAR Underwriting and Claims Evidence Impact"
slug: "/regulatory-change/wsh-mandatory-video-surveillance-construction-1-june-2024"
...
The mandatory VSS regime is part of MOM's broader push to strengthen construction-sector safety. Its lasting effect for insurers and SMEs is evidentiary: every covered worksite now generates a contemporaneous video record of how higher-risk work was carried out, and that record changes how Work Injury Compensation (WIC) and liability claims are investigated and resolved.
...
#### Which worksites are covered

The VSS requirement applies to a **construction worksite** with a **contract sum of S$5 million or more**. Installation is not required for temporary buildings or structures put up for short-term events. How aggregated or related contracts are counted toward the S$5 million threshold should be confirmed against the Regulations for a specific project.
...
VSS footage records identifiable individuals, so it is **personal data** under the Personal Data Protection Act 2012. A contractor running a VSS should notify workers (for example at site induction) that surveillance is in operation, put up **signage** at site entrances and prominent points, restrict access to the footage to authorised personnel, and apply a sensible retention and disposal practice. The WSH and PDPA obligations sit side by side: keeping footage long enough for the 30-day and 180-day WSH rules does not breach the PDPA, but uncontrolled access or indefinite retention can.
...
1. **Misjudging the S$5m threshold.** Treating a project as out of scope without checking the contract sum, or without confirming how related contracts are counted.
...
5. **Purging footage before 180 days.** Deleting incident footage before the claim, investigation and any litigation have run their course.

6. **Neglecting the PDPA.** Operating a VSS with no worker notification, no signage and no access controls.

7. **No sub-contractor flow-down.** Failing to put VSS cooperation into sub-contract terms.
