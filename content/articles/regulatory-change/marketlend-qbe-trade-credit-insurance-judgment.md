---
title: "Marketlend Pty Ltd v QBE Insurance (Singapore) [2025] SGHC(I) 1: Singapore's First Trade Credit Insurance Judgment"
slug: "/regulatory-change/marketlend-qbe-trade-credit-insurance-judgment"
...
**Industry context.** [General Insurance Association of Singapore (GIA)](https://www.gia.org.sg/) addresses TCI market positions; specialty TCI brokers (Aon, Marsh, WTW, Howden) provide market access.
...
1. **Paper-trade structures.** Trade pattern with minimal physical movement; cover unavailable or void.

2. **Assignment without consent.** Invoice finance or factoring arrangement without specific TCI consent.

3. **Incomplete document responses.** Selective response to insurer document requests; condition precedent breached.

4. **Pre-existing dispute non-disclosure.** Commercial dispute affecting payment not disclosed at policy inception.

5. **Counterparty credit limit overrun.** Trading above insurer-approved credit limit; uninsured exposure.

6. **Late overdue notification.** Beyond policy-specified notification window; cover affected.

7. **Substantive trading history non-disclosure.** Pattern of disputes / defaults not disclosed at policy inception.

8. **Multi-buyer concentration.** Specific concentration risks not disclosed; affecting cover terms.

9. **Currency and jurisdiction issues.** Cross-border trade with insufficient cover scope.

10. **Renewal without market test.** Specific TCI market access through specialty broker; missing alternatives.
...
1. For our trade pattern, is it physical-trade-based and what are documentation gaps?
2. For finance arrangements, are TCI assignment consents in place where required?
3. For document compliance, do we have systematic process for insurer requests?
4. For policy inception, was full fair-presentation disclosure made and documented?
5. For renewal, is specialty broker market test demonstrating alternatives?
