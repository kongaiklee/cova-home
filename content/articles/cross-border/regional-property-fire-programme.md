---
title: "Regional Property and Fire Programme: Singapore-HQ SMEs With Property Across Multiple Countries"
slug: "/cross-border/regional-property-fire-programme"
...
canonical_url: "https://covarage.com/cross-border/regional-property-fire-programme"
...
#### The tariff regulations that shape pricing
...
#### The natural catastrophe profile across ASEAN
...
#### Standard scope across regional property programmes
...
Property valuation drives both premium and claim outcomes. Two main approaches:

**Reinstatement value (also called "new for old").** Property valued at the cost to rebuild or replace at the date of loss with new equivalent. Standard for most modern property programmes. Higher premium than indemnity; better claim outcomes.

**Indemnity value (depreciated).** Property valued at the cost to rebuild minus depreciation for age and wear. Lower premium; lower claim outcomes.
...
Business interruption (BI) is typically the most complex part of multi-country property programmes. Considerations:

**Per-country BI vs. group BI.** Each country's BI cover is typically separate. A loss at the Vietnamese factory triggers Vietnamese BI cover. A loss affecting all subsidiaries simultaneously (e.g. group cyber incident) requires careful coordination.
...
When a single event affects multiple jurisdictions (e.g. cyber-driven manufacturing shutdown affecting both Vietnam factory and Thai distribution), claims coordination becomes complex:

- Each country's policy responds to that country's loss
- Causation analysis must be consistent across policies
- Loss adjusters from each country may reach different conclusions
- Documentation requirements differ (local language, local accounting standards)
- BI claim quantification requires consistent methodology

For multi-country incidents, a single coordinating broker typically manages the multi-jurisdiction claim process.

### Common Mistakes / What Goes Wrong

1. **Attempting to use Singapore property cover for foreign-located property.** Generally prohibited under host-country admitted-insurance rules.
2. **Inconsistent valuation methodology across countries.** Mixing reinstatement and indemnity creates strategic exposure.
3. **Indonesian earthquake cover not aligned with PSAGI tariff.** Premium savings achieved through underbuying.
4. **No flood cover in flood-exposed jurisdictions.** Thailand 2011 floods reference case shows the asymmetry.
5. **No earthquake cover in Indonesia/Philippines.** Major seismic exposure left uncovered.
6. **BI indemnity period inconsistent across countries.** A multi-country event may trigger one cover for 12 months and another for 24, creating uneven recovery.
7. **No CBI extension where one subsidiary depends on another.** SG entity revenue loss caused by Vietnam factory loss may be uncovered.
8. **Valuations not updated for capital expenditure.** Underinsurance triggers average clauses.
9. **Local currency vs. functional currency mismatches.** USD-denominated reinstatement values for IDR-billing operations create gaps.
10. **Multiple brokers, no coordination.** Renewal dates drift, specifications diverge, claims handling becomes inefficient.

### What This Means for Your Business

For Singapore-HQ SMEs with property in multiple countries, the discipline:

1. **Maintain a regional property schedule.** All locations, all sums insured, all currencies, updated quarterly.

2. **Engage a coordinated broker network.** Either a single broker with regional offices or an alliance of brokers with formal coordination.
...
1. For each country I have property in, is the cover currently admitted, and does it meet local regulatory requirements?
2. Is my valuation methodology consistent across all countries, and when were valuations last updated?
3. For natural catastrophe exposure in each country (earthquake, flood, typhoon, volcanic), are the relevant perils included with appropriate sub-limits?
4. For BI cover, is the indemnity period consistent across countries, and do I have CBI extension where revenue dependencies exist?
5. At what combined regional property value should I move from standalone country programmes to a coordinated multinational programme?
