---
title: "Multi-Country Regional Structure: Master Programme Architecture for Singapore-Headquartered SMEs"
slug: "/cross-border/multi-country-regional-structure"
...
Singapore-headquartered SMEs operating across multiple jurisdictions face commercial complexity that substantially exceeds the considerations applicable to single-country cross-border operations. Singapore-issued cover operates within the [Insurance Act 1966](https://sso.agc.gov.sg/Act/IA1966) framework administered by [MAS](https://www.mas.gov.sg/), with industry conventions documented by the [General Insurance Association of Singapore (GIA)](https://www.gia.org.sg/). EU operations sit within [Solvency II](https://www.eiopa.europa.eu/) framework. Specific Political Risk Insurance frameworks include [Multilateral Investment Guarantee Agency (MIGA)](https://www.miga.org/), [African Trade Insurance Agency (ATI)](https://www.ati-aca.org/), and specialist [Lloyd's of London](https://www.lloyds.com/) syndicates.
...
**Substantively admitted markets** include India (per [Article 230](#article-230)), the Philippines (per [Article 231](#article-231)), Taiwan (per [Article 232](#article-232)), Korea (per [Article 213](#article-213)), Thailand (per [Article 215](#article-215)), Indonesia (per [Article 109](#article-109)), Vietnam (per [Article 127](#article-127)), and specific other markets. In these markets, insurance covering local risks must generally be placed with locally-licensed insurers.

**Substantively non-admitted-permissive markets** include the United Kingdom (per [Article 214](#article-214)), Australia (per [Article 157](#article-157)), New Zealand (per [Article 234](#article-234) — though typically practical to use locally-issued cover for ACC integration), Singapore itself, and specific other markets where non-admitted cover may be permissible under specific commercial frameworks.

**Mixed-frameworks** include the United States (per [Article 166](#article-166) where state-by-state framework varies), the European Union (per [Article 235](#article-235) where Solvency II passporting creates complex commercial scope), Japan (per [Article 147](#article-147)), and specific other markets.
...
| Jurisdiction | Primary mandatory frameworks |
|---|---|
| Singapore | CPF, MediShield Life, WICA |
| Malaysia | EPF, SOCSO, EIS, HRD |
| Indonesia | BPJS Kesehatan, BPJS Ketenagakerjaan |
...
| Taiwan | NHI, Labor Insurance, Labor Pension, Employment Insurance |
| New Zealand | ACC, KiwiSaver |
| Australia | Workers' Comp (state), Super, Medicare |
| UK | NI, Pension Auto-Enrolment, Health & Safety |
| EU/Germany | Sozialversicherung 5-pillar |
| US | Workers' Comp (state), specific federal frameworks |
...
| Jurisdiction | Primary data protection framework |
|---|---|
| Singapore | PDPA |
...
| EU | GDPR |
| US | State-by-state (CCPA, SHIELD Act, specific others) |
...
- [Singapore SMEs Operating in the EU and Germany: Cross-Border Insurance and Commercial Framework](/cross-border/sg-sme-eu-germany-operations)
