---
title: "Regional Marine Cargo for ASEAN Trade: Single-Programme Architecture Across Multiple Jurisdictions"
slug: "/cross-border/regional-marine-cargo-asean"
...
meta_description: "Marine cargo works as one programme out of Singapore because the Institute Cargo Clauses are accepted by convention. Where that convenience stops."
og_title: "Regional Marine Cargo for ASEAN Trade: Single-Programme Architecture Across Multiple Jurisdictions"
og_description: "Marine cargo works as one programme out of Singapore because the Institute Cargo Clauses are accepted by convention. Where that convenience stops."
---
...
Singapore is one of the world's largest marine insurance markets, supported by [PSA Singapore](https://www.singaporepsa.com/) port volumes and the Singapore Lloyd's Asia hub. For regional SMEs trading across ASEAN, a Singapore marine cargo programme is typically the most efficient structure available. The mechanics differ from local-jurisdiction property and liability programmes.
...
1. **Map trade lanes annually.** Origins, destinations, transit ports, modes (sea, air, road, rail).

2. **Match programme structure to volume.** Open Cover for regular trade; per-shipment for occasional; stock-throughput where storage and transit overlap.
...
1. For my current trade lanes, is an Open Cover, per-shipment, or stock-throughput structure most appropriate?
2. For my specific commodities, is ICC A, B, or C the appropriate clause selection, and what extensions matter?
3. How is war and strikes cover structured currently, and how do JWC listings affect my routes?
4. As I expand to a new country or add a new product line, what is the process to extend territorial scope or add the line to the Open Cover?
5. For my supply chain, do I have warehouse storage exposures that should be on a stock-throughput rather than separate cargo and property policies?
