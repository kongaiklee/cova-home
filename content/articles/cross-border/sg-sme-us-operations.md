---
title: "Singapore SME With US Operations: How Insurance Works for US Subsidiaries and Branches"
slug: "/cross-border/sg-sme-us-operations"
...
>
> Singapore SMEs operating in the United States face the most complex insurance environment of any common cross-border destination. Required: state-by-state **Workers' Compensation** (mandated separately by each state — California's [DIR](https://www.dir.ca.gov/), New York's [WCB](https://www.wcb.ny.gov/), Texas as a notable opt-out state with specific implications), **Employer's Liability** (often bundled with Workers' Comp), **Commercial General Liability (CGL)** at substantial limits (US$1M / US$2M aggregate is baseline, but commercial customers and landlords frequently demand US$5M-US$10M+), **Commercial Auto** with state-specific minimums and significant litigation exposure, **Property** for premises and equipment, **Cyber Liability** with substantial limits given US class-action and state regulator exposure ([CCPA](https://oag.ca.gov/privacy/ccpa) in California, [SHIELD Act](https://ag.ny.gov/) in New York, plus 50 state breach notification laws), and where applicable **Professional Liability / E&O**, **Product Liability** (significant given US tort environment), **Directors & Officers**, and **EPLI (Employment Practices Liability Insurance)** which is functionally essential given US employment litigation frequency. The most distinctive US risks: **plaintiffs' bar litigation environment** (jury verdicts an order of magnitude above Singapore norms), **state-by-state regulatory complexity**, and **substantial Cyber exposure** given the US class-action environment.
...
**Federal registration** centres on the Federal Employer Identification Number (EIN) from the [IRS](https://www.irs.gov/), plus any industry-specific federal licensing.
...
- **[ERISA](https://www.dol.gov/agencies/ebsa/laws-and-regulations/laws/erisa)** — the Employee Retirement Income Security Act governs employer-sponsored benefit plans, imposing fiduciary obligations and reporting requirements.
- **[HIPAA](https://www.hhs.gov/hipaa/)** — the Health Insurance Portability and Accountability Act sets privacy and security frameworks for employer health plans and any healthcare-related operations.
...
The federal enforcers are the [EEOC](https://www.eeoc.gov/) (Equal Employment Opportunity Commission) and the [DOL](https://www.dol.gov/) (Department of Labor), and several states are markedly more active — California especially, through mechanisms such as PAGA (the Private Attorneys General Act).
...
**State frameworks** are the bigger complexity: all **50 states have breach-notification laws**, each with its own timelines and scope. On top of that sit comprehensive privacy statutes — [CCPA / CPRA](https://oag.ca.gov/privacy/ccpa) in California, the [SHIELD Act](https://ag.ny.gov/) in New York, and further regimes in Texas, Virginia, Colorado, Connecticut, Utah, and others.
...
1. **Underestimating litigation exposure.** US settlements and jury verdicts run an order of magnitude above Singapore norms.
2. **Underestimating Workers' Compensation cost variation.** State-by-state premium varies materially.
3. **Treating EPLI as optional.** It is functionally essential in the US.
4. **Cyber inadequate for the US class-action environment.**
5. **Product Liability inadequate for the US strict-liability and tort environment.**
6. **Underestimating state-by-state compliance complexity.**
7. **Industry-specific licensing overlooked.** State requirements differ.
8. **Commercial-customer and landlord certificate requirements not met.**

### Common Mistakes / What Goes Wrong

1. **Operating without US-licensed insurance.** Regulatory non-compliance.
2. **Workers' Compensation gaps by state.** Mandatory non-compliance.
3. **CGL limits inadequate for US commercial requirements.** Commercial customers routinely demand far more than the baseline.
4. **No EPLI.** A major exposure given the US employment-litigation environment.
5. **Cyber Liability inadequate for the US class-action environment.**
6. **Product Liability inadequate for the US tort environment.**
7. **No coordination between the Singapore parent and the US subsidiary.** Silos and gaps.
8. **Industry-specific licensing overlooked.** State-specific exposure.

### What This Means for Your Business

For Singapore SMEs with US operations:

1. **Engage a US local broker for material operations.** The market is the most sophisticated globally and warrants specialist engagement.

2. **Substantial Cyber and EPLI are essential.** Neither is optional in the US environment.

3. **Coordinate the Singapore parent and US subsidiary insurance** — a master/local or DIC/DIL structure.

4. **Address foreign-employee considerations specifically** — including that there is no US–Singapore tax treaty.

5. **For regulated industries, confirm the federal and state compliance requirements.**

6. **Address Product Liability deliberately.** The US strict-liability framework makes it a major exposure.

7. **Review annually across both jurisdictions.**

8. **Plan for scale.** Each growth stage in the US has insurance implications.
...
1. For my US operations, what cover is legally mandatory and what is commercially essential?
2. How does my Singapore parent insurance coordinate with the US local cover?
3. What are the state Workers' Compensation, EPLI, and Cyber requirements for the states I operate in?
4. For Product Liability, what cover and limits apply in the US environment?
5. As my US operations scale, what insurance milestones should I plan for?
