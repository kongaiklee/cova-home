---
title: "Cyber Insurance: First-Party vs Third-Party Cover and What Each Pays"
slug: "/comparison/cyber-first-party-vs-third-party-cover-singapore"
category: "comparison"
...
meta_description: "A cyber policy has two halves. First-party pays your own breach costs, third-party pays what you owe others. Which half a Singapore claim falls in decides."
og_title: "Cyber Insurance: First-Party vs Third-Party Cover and What Each Pays"
og_description: "A cyber policy has two halves. First-party pays your own breach costs, third-party pays what you owe others. Which half a Singapore claim falls in decides."
---
...
- **Privacy and network security liability.** Defence costs and damages for claims brought by people whose data you held, typically customers and employees, when a breach exposes that data. The legal foundation of that exposure in Singapore is the [protection obligation in section 24 of the PDPA](https://sso.agc.gov.sg/Act/PDPA2012), which requires an organisation to make reasonable security arrangements to protect personal data in its possession or control. A failure to meet that standard is the hook on which a privacy claim or complaint hangs.
- **Regulatory defence and penalties.** The cost of responding to and defending a [PDPC](https://www.pdpc.gov.sg/) investigation, and, where the wording and the law allow it to be insured, the [financial penalty the Commission may impose under section 48J of the PDPA](https://sso.agc.gov.sg/Act/PDPA2012). The current penalty ceiling and how it is calculated have moved over time, so treat the figure as something to confirm against a dated source rather than memorise. We track it separately in our note on [notification cost in the limit versus a sub-limit for SMEs](/comparison/cyber-notification-cost-in-limit-vs-sub-limit-sme).
...
4. **Ignoring the notification clock.** [Section 26D](https://sso.agc.gov.sg/Act/PDPA2012) sets a 3-calendar-day window to notify the PDPC after assessing a breach as notifiable. A policy whose breach-response line is too thin to fund a fast forensic assessment puts that deadline at risk.

5. **Overlooking media liability when it is genuinely needed.** A content or publishing business that skips media liability leaves a real third-party gap that the privacy section will not fill.

6. **Assuming a PDPC financial penalty is automatically insurable.** Whether a [section 48J penalty](https://sso.agc.gov.sg/Act/PDPA2012) can be insured, and to what extent, depends on the wording and the law. Confirm it rather than assume it.
...
Covarage helps with the part that quietly goes wrong: keeping the policy schedule and its sub-limits organised in one place so you can see both halves at a glance, sending with every renewal date visible in one place, and routing you to a licensed adviser when you need to compare how two policies split first-party and third-party cover.

### Questions to Ask Your Adviser

1. Does this policy have both a first-party and a third-party section, and what is the limit on each?
2. For my business, which half carries the larger exposure, and are the limits set accordingly?
3. What are the sub-limits on business interruption, regulatory defence, and cyber extortion, and how do they compare to the headline figure?
4. Does the third-party section respond to a PDPC investigation under the PDPA, and is a section 48J financial penalty insurable under this wording?
