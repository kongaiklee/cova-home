...
Per the [SMC Practising Certificate page](https://www.smc.gov.sg/for-professionals/registered-doctors/practising-certificate/), every fully or conditionally registered medical practitioner must apply for and renew a PC to practise medicine in Singapore. PC renewal requires CME compliance and other criteria.

The SMC Ethical Code and Ethical Guidelines (2016 edition) and the [Medical Registration Act 1997](https://sso.agc.gov.sg/Act/MRA1997) establish the regulatory framework. Per Section 13 of the MRA: "you are not allowed to practise as a medical practitioner or do any act as a medical practitioner unless you are registered under this Act and have a valid PC."
...
Per the [Singapore Medical Association](https://www.sma.org.sg/page/professional-indemnity-20), the SMA Council has identified three Preferred Partners for medical malpractice indemnity: **Medical Protection Society (MPS)**, **Income**, and **Marsh (Medefend)**. A fourth provider, **Jardine Lloyd Thompson (JLT)** as insurance broker, has been added.

**Medical Protection Society (MPS)** — Per [MPS Singapore](https://www.medicalprotection.org/singapore) and the [Wikipedia overview](https://en.wikipedia.org/wiki/Medical_Protection_Society), MPS is a UK-based mutual protection organisation founded in 1892, with more than 300,000 members worldwide. Per the [Inside Medical Liability interview with MPS CEO Simon Kayll](https://www.mplassociation.org/Web/Publications/Inside_Medical_Liability/Issues/2023/articles/Summer/Kayll-Steers_UK_Medical_Protection_Society_Through_Indemnity_Changes.aspx): "MPS is not regulated in any of the jurisdictions in which we operate." MPS provides discretionary indemnity — the council decides whether to assist a member when a claim arises, based on the Memorandum and Articles of Association. There is no stated policy limit. The structure has historically been **occurrence-based** (cover triggered by when the medical event occurred, not when the claim is made).

**Income / Income Insurance Limited** — A traditional regulated Singapore insurer. Per [SMA's listing](https://www.sma.org.sg/page/professional-indemnity-20), Income offers both occurrence-based and claims-made structures.
...
Per the [SMA explanatory article on the differences](https://www.sma.org.sg/news/2019/November/medical-malpractice-indemnity-solutions--the-differences-between-discretionary-indemnity-and-insurance):
...
Per the [MOH Holdings Medical Malpractice Insurance page](https://www.mohh.com.sg/MMI/home.html): *"With effect from 1 January 2017... all doctors and dentists employed by Singapore's Public Healthcare Institutions ('PHIs') are covered by the MOHH Medical Malpractice Insurance ('MMI') programme... Administered by Marsh Singapore ('Marsh'), the MMI covers claims for malpractice, negligence, disciplinary and regulatory matters."*

Per the [MPS Singapore notice on the public-sector arrangement](https://www.medicalprotection.org/singapore/casebook-resources/mps-connect/important-information-about-medical-protection-in-singapore), MPS members in private practice were unaffected; public-sector members joined the MOHH scheme but could continue private MPS membership for any private work.
