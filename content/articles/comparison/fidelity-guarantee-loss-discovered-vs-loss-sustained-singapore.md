---
title: "Fidelity Guarantee and Commercial Crime: Loss-Discovered vs Loss-Sustained Trigger Decision Framework"
slug: "/comparison/fidelity-guarantee-loss-discovered-vs-loss-sustained-singapore"
category: "comparison"
...
**[Limitation Act 1959](https://sso.agc.gov.sg/Act/LA1959).**
...
**[Companies Act 1967](https://sso.agc.gov.sg/Act/CoA1967).** Directors' duties - including the duty to act with reasonable diligence and in the company's interest - frame the corporate-governance obligation to detect employee fraud and to file claims within the limitation period. Directors who knew or should have known of fraud and failed to act expose themselves to potential personal liability under section 157.

**[Penal Code 1871](https://sso.agc.gov.sg/Act/PC1871).** Criminal offences of criminal breach of trust (sections 405-409) and cheating (sections 415-420) frame the parallel criminal jurisdiction. An insurer typically requires the insured to report to the Singapore Police Force Commercial Affairs Department for Discovery-trigger claims above material thresholds. The reporting obligation is conditional on the policy wording and is critical for preserving the insurer's subrogation rights against the dishonest employee.

**[Insurance Act 1966](https://sso.agc.gov.sg/Act/IA1966) and Insurance (General Provisions) Regulations.** Regulate the conduct of the insurer but do not prescribe a trigger.
...
1. Is our cover written on Discovery or Loss-Sustained trigger?
2. If Discovery, what is the retroactive date, and does it cover our full historical exposure period?
3. What is the Extended Period to Discover Loss (typically 60-90 days post-expiry), and do we have a 12-month run-off endorsement option?
4. Are we writing bare Fidelity Guarantee (Employee Dishonesty only) or full Commercial Crime (including Computer Fraud, Funds Transfer Fraud, Forgery)?
5. Does the employee definition include directors and senior management, or are they carved out?
6. Is the limit sized against credible multi-year cumulative exposure, not just single-event exposure?
7. How does this cover coordinate with our cyber policy on Funds Transfer Fraud and Computer Fraud insuring clauses?
