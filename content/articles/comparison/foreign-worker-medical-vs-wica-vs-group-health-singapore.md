---
title: "Foreign Worker Medical Insurance vs WICA vs Group Health: What Each Actually Covers"
slug: "/comparison/foreign-worker-medical-vs-wica-vs-group-health-singapore"
category: "comparison"
intent: "make-the-call"
topics: ["Work Injury (WICA)", "Foreign Workers", "Group Health"]
...
meta_description: "For a migrant worker, three different covers get confused, and two of them are required by law. The first is foreign worker medical insurance: under the..."
og_title: "Foreign Worker Medical Insurance vs WICA vs Group Health: What Each Actually Covers"
og_description: "For a migrant worker, three different covers get confused, and two of them are required by law. The first is foreign worker medical insurance: under the..."
---
...
| --- | --- | --- | --- |
| Mandatory? | Yes, work pass condition under the [Work Passes Regulations 2012](https://sso.agc.gov.sg/SL/EFMA1990-S569-2012?ViewType=Pdf) | Yes, under [s 24 WICA 2019](https://sso.agc.gov.sg/Act/WICA2019) | No |
...
1. **Assuming WICA covers the worker's medical bills generally.** WICA pays statutory compensation for work injury and occupational disease. A non-work hospitalisation is outside it entirely; that is what the medical insurance condition exists for.

2. **Assuming the foreign worker medical policy satisfies the WICA duty.** It does not. The [section 24 WICA](https://sso.agc.gov.sg/Act/WICA2019) duty requires an approved policy with a designated WICA insurer against work-injury liabilities. A hospitalisation policy is a different instrument and does not meet that test.
...
6. **Forgetting local and non-resident staff sit outside the foreign worker medical condition.** That condition attaches to Work Permit and S Pass holders. Local employees are not covered by it, and group health is usually the route if the employer wants medical cover for them.
...
Covarage helps with the part that quietly goes wrong here: keeping the medical insurance, WICA, and any group plan organised in one place, with every renewal date visible in one place, and a route to a licensed adviser when you need to arrange or compare cover across all three.

### Questions to Ask Your Adviser

1. Is every Work Permit and S Pass holder covered by a medical insurance policy that meets the current Eighth Schedule requirements, including the post-1-July-2025 limits and co-payment terms?
2. Is our WICA cover with a designated insurer, and does it cover all in-scope employees including our foreign workers?
3. If a migrant worker is hospitalised after a workplace accident, which of the three covers respond, and in what order?
4. Does our group health plan, if any, exclude events already covered by WICA, and is that exclusion clear in the wording?
