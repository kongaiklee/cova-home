---
title: "Fire Insurance vs Property All Risks (PAR): What's the Difference and How Claim Mechanics Actually Work"
slug: "/comparison/fire-vs-par-claim-mechanics"
category: "comparison"
...
canonical_url: "https://covarage.com/comparison/fire-vs-par-claim-mechanics"
meta_description: "Fire insurance covers loss / damage to property from a defined list of perils - fire, lightning, explosion (within specified limits), and specific named..."
og_title: "Fire Insurance vs Property All Risks (PAR): What's the Difference and How Claim Mechanics Actually Work"
og_description: "Fire insurance covers loss / damage to property from a defined list of perils - fire, lightning, explosion (within specified limits), and specific named..."
---
...
| Peril | Fire policy | PAR policy |
|---|---|---|
| Fire damage | Covered | Covered |
| Water damage from a burst pipe | Only if endorsed | Typically covered (escape of liquid) |
| Theft | Only if endorsed | Typically covered (unless excluded) |
| Accidental impact damage | Only via aircraft / vehicle impact endorsements | Typically covered |
| Vandalism | Only if endorsed (RSMD) | Typically covered |
| Equipment falls / accidental damage | Typically not covered | Typically covered |
| Storm / tempest | Only if endorsed | Typically covered |
| Flood | Only if endorsed | Typically covered |
...
A **Fire claim** additionally turns on documenting the cause - including fire-service / [SCDF](https://www.scdf.gov.sg/) reports and any cause investigation (Singapore courts' treatment of proximate-cause analysis can be traced through [eLitigation](https://www.elitigation.sg/) judgments). A **PAR claim** turns on evidence that defends against the exclusions - most importantly, evidence that the loss was sudden and accidental rather than gradual.
