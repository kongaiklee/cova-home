---
title: "5 Things Your Insurance Adviser Should Be Doing (That Most Do Not)"
slug: "/comparison/5-things-insurance-adviser-should-do-singapore"
category: "comparison"
...
meta_description: "The MAS conduct framework for financial advisers in Singapore sets out the floor of what an adviser must do - reasonable basis for recommendations under..."
og_title: "5 Things Your Insurance Adviser Should Be Doing (That Most Do Not)"
og_description: "The MAS conduct framework for financial advisers in Singapore sets out the floor of what an adviser must do - reasonable basis for recommendations under..."
---

> **The Answer in 60 Seconds**
>
> The MAS conduct framework for financial advisers in Singapore sets out the **floor** of what an adviser must do - reasonable basis for recommendations under [MAS Notice FAA-N16](https://www.mas.gov.sg/regulation/notices/notice-faa-n16), information to clients and product-information disclosure under [MAS Notice FAA-N03](https://www.mas.gov.sg/regulation/notices/notice-faa-n03), and conduct standards under the [Financial Advisers Act 2001](https://sso.agc.gov.sg/Act/FAA2001). The floor is necessary but not sufficient for an SME's ongoing insurance relationship. Five things lift the relationship from compliant to useful: (1) **annual coverage review** that is not the same conversation as the renewal, (2) **proactive business-change alerts** when something happens that affects the rating or the cover, (3) **claims-documentation guidance** before a claim happens, (4) **multi-insurer comparison** at every renewal rather than a defensive same-insurer roll-forward, and (5) **post-claim debrief** to identify what should change in the cover or the process. This article sets out what each looks like in practice, what most advisers actually do, and how to ask for the difference at the next renewal.
...
**What most do:** Conduct a renewal conversation. The conversation focuses on the immediate quote, the prior-year terms, and the headline premium. Coverage review is implicit in the renewal but not explicit.
...
The [60-minute audit framework](/procedural-howto/business-insurance-audit-60-minutes-singapore) is the SME-side counterpart to the adviser's coverage review.

#### 2. Proactive business-change alerts

**What most do:** Respond to questions when the SME raises a business change. The SME has to know that the change is relevant and has to remember to raise it.

**What the better advisers do:** Build into the relationship a **structured prompt** that asks, at each scheduled touchpoint, whether anything has changed. The prompt covers: new premises, new product or service line, new contract type, new senior hire, new sub-contractor relationship, new country of operation, change in shareholders or directors. The adviser then translates each change into an insurance implication: the new product may require an extension to PI; the new sub-contractor may require an endorsement on PL; the new senior hire may require addition to D&O.

The proactive alert is the difference between cover that tracks the business and cover that lags it. The lag becomes visible only at claim time, when the change that was not notified is the change that the claim turns on.

#### 3. Claims-documentation guidance before a claim happens

**What most do:** Provide guidance when a claim is notified. The guidance is reactive and is delivered under the time pressure of the claim event.
...
The playbook is particularly valuable for claims-made covers (PI, D&O, cyber, EPL, crime) where notification windows are short and the consequence of missed notification is the loss of cover for that claim.

See [the document trail that saved (and sank) a claim](/procedural-howto/document-trail-business-insurance-claim-singapore) for the document architecture the playbook supports.

#### 4. Multi-insurer comparison at every renewal

**What most do:** Approach the incumbent insurer for renewal terms. If the terms are reasonable, recommend continuation. Approach the market only if the incumbent's terms are visibly poor or if the SME initiates the request.
...
The multi-insurer approach is harder for the adviser - more underwriting submissions, more comparison work, more meetings. It is the practice that most clearly differentiates ongoing professional service from defensive renewal handling.

Where the adviser is a tied agent, structural multi-insurer comparison is not available; the SME is on the principal's products. The [channel distinction](/comparison/tied-agent-ifa-insurance-broker-singapore-business) matters because the multi-insurer expectation can only be met by licensed advisers or brokers.

#### 5. Post-claim debrief

**What most do:** Close the claim file when the insurer settles. The SME and the adviser move on to the next renewal.
...
The debrief is short - typically a single meeting - but it is the only mechanism by which the SME's programme actually improves over time. Without it, the same gaps recur claim after claim.

#### Why most advisers do not do these five things

The reasons are structural rather than personal. Most advisers carry larger books than would allow systematic application of these five practices to every client; the practices accordingly concentrate on the largest clients by premium volume. The advisers who do apply the five practices to SME clients typically do so as part of a defined service model that prices the time accordingly.
...
The third option is the most common in mid-sized Singapore SMEs that have grown past the simplest insurance needs but have not reached the scale to support a full brokered relationship.
...
5. **No post-claim debrief.** The single most valuable improvement mechanism is the one most often skipped.

6. **Treating adviser conduct disputes as direct conversations only.** [FIDReC](https://www.fidrec.com.sg/) provides a formal route when direct resolution does not work.
...
9. **Conflating adviser change with insurer change.** Changing adviser does not change the policy; the SME's policies remain in force unless the adviser was also handling premium payment.

10. **Not asking for the conduct framework that applies.** [FAA-N16](https://www.mas.gov.sg/regulation/notices/notice-faa-n16) and [FAA-N03](https://www.mas.gov.sg/regulation/notices/notice-faa-n03) are the floor; the adviser should be able to articulate them.
