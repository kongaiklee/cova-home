---
title: "Business Interruption Deductible: Hours-Based vs Day-Based vs Dollar-Based Waiting Period"
slug: "/comparison/bi-waiting-period-hours-vs-days-vs-dollar"
category: "comparison"
...
1. **Focusing on the waiting period and under-sizing the Indemnity Period.** For a Singapore SME requiring 18-24 months to rebuild a fire-damaged factory and recover lost customers, a 12-month Indemnity Period is the binding constraint, not the waiting period. The SME absorbs significant uninsured loss at the back end of the interruption.
...
5. **Missing the "in addition to" hybrid trap.** Where the wording uses "time excess AND monetary deductible in addition", both apply cumulatively. SMEs comparing quotes on headline waiting period without testing the hybrid structure are easily misled.
...
1. What is our current BI Indemnity Period, and how does it compare against realistic rebuilding plus customer recovery time?
2. Is our waiting period hours-based, day-based, dollar-based, or hybrid, and if hybrid, is the structure "greater of" or "in addition to"?
3. For day-based waiting periods, is "day" defined as business day or calendar day?
4. Is the Increased Cost of Working sub-limit adequate against our realistic mitigation cost profile?
5. Is cyber-triggered BI within our property+BI package, or separately written under a cyber policy with shorter waiting?
6. Is gross profit declared at current projected level or at historical, and is there an Average clause on BI similar to property?
7. At renewal, are we re-testing the rebuilding timeline assumption against current Singapore construction-cost and labour-availability conditions?
