---
title: "WFA 2024 Protected Characteristics: A Deep-Dive on the Statutory Framework"
slug: "/document-legal/wfa-2024-protected-characteristics"
...
>
> The [Workplace Fairness Act 2024 (WFA)](https://sso.agc.gov.sg/Act/WFA2025) - passed by Parliament on 8 January 2025 - establishes Singapore's first comprehensive statutory framework prohibiting workplace discrimination on protected characteristics. **It is not yet in force:** the WFA is uncommenced, expected to take effect by the end of 2027, and employers with fewer than 25 employees will be exempt for the first five years. Once in force, the Act will protect against discrimination on **age, nationality, sex, marital status, pregnancy status, caregiving responsibilities, race, religion, language, disability, and mental health condition**, plus specific other characteristics per the Act. Discrimination is prohibited in **recruitment, promotion, compensation, performance management, and termination**. The framework operates alongside [TAFEP](https://www.tafep.sg/) tripartite guidance and creates statutory rights actionable through TADM mediation and the Employment Claims Tribunal under the [Employment Claims Act 2016](https://sso.agc.gov.sg/Act/ECA2016). Specific exemptions exist for bona fide occupational qualifications and other defined contexts. For Singapore SMEs, the framework substantially elevates the importance of **EPL (Employment Practices Liability Insurance)** and creates specific HR documentation expectations. This article provides a deep-dive on the protected characteristics; for general framework discussion see [Article 171](/regulatory-change/wfa-2024-phase-2-implementation), and for the integrated employment framework see [Article 179](/regulatory-change/employment-framework-2026-updates).
...
- Bona fide retirement age policies (within the [Retirement and Re-employment Act](https://sso.agc.gov.sg/Act/RRA1993) framework)
...
- Specific Singaporean / PR preference under [Fair Consideration Framework](https://www.mom.gov.sg/) for work pass roles
...
WFA pregnancy protection operates alongside the [Employment Act](https://sso.agc.gov.sg/Act/EmA1968) maternity protection framework (specific maternity leave, specific protection from termination). Together they create comprehensive pregnancy-related protection.
...
**TAFEP mediation.** Specific complaint handling per [TAFEP framework](https://www.tafep.sg/).

**TADM mediation.** Specific tripartite mediation under [Employment Claims Act 2016](https://sso.agc.gov.sg/Act/ECA2016).
...
4. **No reasonable accommodation framework.** Specific direct claim risk.
5. **No manager training.**
6. **EPL inadequate for expanded claim landscape.**
7. **No complaint handling framework.**
8. **Specific privacy issues with protected characteristic information.** Specific compliance risk.
9. **No compensation analysis for equivalence.**
...
4. **Reasonable accommodation disability and mental health.** operational requirement.

5. **Specific manager training.** operational and cultural foundation.

6. **Specific complaint handling framework.** operational requirement.

7. **For specific industries with elevated patterns, specific industry-aware guidance.**

8. **Annual policy and practice review.** Specific evolving framework.
