...
The third party is the key word. Public liability does not cover injury to your own employees, that is the domain of work-injury cover under the [WICA 2019](https://sso.agc.gov.sg/Act/WICA2019), and it does not cover damage to your own property. It covers the outside world: customers, visitors, neighbours, passers-by, and their belongings. The mechanics of a real claim, from the moment an injury happens on your premises, are walked through in [the first 48 hours after a customer bodily injury at your premises](/crisis/customer-bodily-injury-premises-first-48-hours-singapore) and, for food-and-beverage operators specifically, in [how to file a public liability claim after a customer slip in a cafe](/procedural-howto/pl-claim-customer-slip-fnb).
...
First, **commercial leases and mall tenancies.** A standard tenancy agreement typically obliges the tenant to carry public liability insurance of a stated minimum limit and to name the landlord or mall operator as an interested party or additional insured. How such clauses are drafted and what they bind you to operationally is covered in [standard insurance clauses in commercial contracts](/document-legal/standard-insurance-clause-commercial-contracts).

Second, **government and construction tenders.** Public-sector and main-contractor procurement in Singapore frequently runs on the Public Sector Standard Conditions of Contract (PSSCOC), which carry their own insurance requirements that a tenderer must satisfy to qualify. The compliance steps are set out in [how to comply with PSSCOC insurance clauses for a government construction tender](/procedural-howto/psscoc-insurance-clauses-government-tender-singapore). Contractors weighing how to structure cover across multiple jobs should also read [annual blanket CAR vs project-specific CAR](/comparison/annual-blanket-car-vs-project-specific-car-sme-contractor), since public liability often sits alongside the works cover in a construction programme.

Third, **event and venue bookings.** MICE venues, convention centres, and many public spaces will not confirm a booking without proof of event public liability cover at a specified limit. The procurement route is in [how to obtain event liability insurance for MICE events and venue bookings](/procedural-howto/event-liability-insurance-singapore-mice-venue), the claims side in [how to file a public liability claim after an event slip and fall](/procedural-howto/pl-claim-event-slip-fall), and the full cover stack for an event business in [the insurance checklist for opening an event management company](/decision-tree/opening-event-management-company-checklist).

The legal device that lets a landlord or principal who is not the policyholder still claim on your policy is the [Contracts (Rights of Third Parties) Act 2001](https://sso.agc.gov.sg/Act/CRTPA2001). Section 2 of that Act lets a third party enforce a contract term that expressly confers a benefit on them, or that purports to do so, provided they are identified by name, class, or description. That is exactly how an "additional insured" clause works. The commercial consequences of granting those rights are unpacked in [the CROTPA 2001 additional-insured article](/document-legal/crotpa-2001-additional-insured-third-party-rights).
...
One further protection sits behind the policy itself. If the insurer that wrote your cover were to fail, the [SDIC Policy Owners' Protection Scheme](/regulatory-change/sdic-policy-owners-protection-scheme-sme-coverage) sets out what a Singapore policyholder can and cannot recover, which matters when you are relying on a single policy to satisfy a contractual obligation.
...
- **Product liability** answers for injury or damage caused by a **product after it has left your hands**: the food that causes illness, the goods that fail and injure a user. The two are frequently sold together as a "public and product liability" section, but the triggers and sub-limits differ. The line is drawn in [public liability vs product liability: what each actually covers](/comparison/pl-vs-product-liability), and the supply-of-goods backdrop in [the Sale of Goods Act 1979 implied terms](/document-legal/soga-1979-implied-terms). Businesses operating across borders should read [regional public and product liability](/cross-border/regional-public-product-liability).
...
2. **Assuming a wet-floor sign discharges the duty.** After [See Toh Siew Kee](/document-legal/see-toh-siew-kee-occupiers-liability), the test is whether you took reasonable care in all the circumstances, not whether you performed one ritual.
...
5. **Signing a lease or tender without checking the required limit and additional-insured wording.** The contract, not the broker's default, sets what you must carry. See [standard insurance clauses in commercial contracts](/document-legal/standard-insurance-clause-commercial-contracts).

6. **Treating public and product liability as the same thing.** They have different triggers. A product claim can fall outside a public-liability-only policy. See [public liability vs product liability](/comparison/pl-vs-product-liability).
