---
title: "IRDA 2018 and Director Personal Liability in Insolvency: How Singapore Law Handles Distressed Companies and What D&O Insurance Actually Covers"
slug: "/document-legal/irda-2018-director-duties-insolvency"
...
The [IRDA 2018](https://sso.agc.gov.sg/Act/IRDA2018) consolidates and modernises Singapore's insolvency framework. The corporate routes it provides are:
...
5. **Governance** - increase board engagement and keep decision-making and accountability clear.
...
5. **No D&O cover during distress.** Personal exposure unmitigated.
6. **No run-off cover at exit or dissolution.** Past directors left exposed.
7. **Treating the company in isolation where the group spans jurisdictions.** Multi-jurisdictional exposure missed.
8. **No early engagement with a licensed insolvency practitioner.** The company loses commercial and legal guidance when it most needs it.
9. **Governance allowed to weaken during distress.** Decision-making becomes hard to defend.
10. **Transactions conferring a personal benefit on a director.** Significant exposure, including potential criminal liability.

### What This Means for Your Business

For Singapore SME directors and founders:

1. **Maintain D&O cover** - especially as the company scales and through any period of financial pressure.

2. **Plan run-off cover at material transitions** - sale, restructuring, or dissolution.
...
6. **Maintain creditor and stakeholder communication.**

7. **For group or multi-jurisdiction structures, use specialist counsel.**

8. **Take personal financial advice** matched to the exposure the role carries.
...
1. For my company stage and risk profile, what D&O structure is appropriate?
2. How does my D&O respond to the IRDA scenarios - wrongful trading (s.239), fraudulent trading (s.238), transactions at undervalue (s.224), unfair preferences (s.225)?
3. For run-off / extended reporting cover at a material transition, what considerations apply?
4. Does my D&O coordinate with PI and EPL for related claims?
5. As my company scales or faces financial pressure, what insurance milestones should I plan for?
...
Articles 150-152 expand Decision Trees with three operationally-distinct services categories: tuition / enrichment centre (MOE registration, PEI / EduTrust framework via SSG-CPE, child safety as dominant exposure, PDPA Section 26D significant-harm for minor data, transport / off-premises activity considerations), tour / travel agency (STB Travel Agents Licence under Travel Agents Act 1975, TISP framework, supplier failure exposure, BEC / Social Engineering Fraud as foundational Cyber consideration given travel industry targeting profile), and logistics / warehousing operation (Singapore Customs Declaring Agent registration, Goods in Trust / Bailee cover as the critical specialty layer that standard PL excludes, Marine Cargo Liability with SLA Standard Trading Conditions, fleet motor coordination, multi-commodity considerations from cold chain to dangerous goods to e-commerce fulfilment). Articles 153-154 continue Edge Case with two distinctive Singapore commercial categories: tattoo studio / body piercing (NEA hygiene standards, Treatment Risk / Body Modification Liability for procedure-related claims, infection / cross-contamination as dominant underwriting consideration, contractor artist WICA classification per Article 67) and second-hand luxury reseller (SPF Second-Hand Goods Dealers Act 2007 registration, All Risks Stock cover with declared inventory replacing inadequate jewelry sub-limits, Crime / Money proportionate to theft target profile, authentication PI for counterfeiting disputes, Bailee cover for consignment models). Articles 155-156 continue Crisis with two scenarios where insurance plays specific but limited roles: partner exit / shareholder dispute (Companies Act Section 216 minority oppression, shareholders' agreement framework as primary dispute-resolution mechanism, D&O Insured vs Insured exclusion, Key Person considerations, operational continuity through transition) and IRAS audit / investigation (Income Tax Act Sections 65/65A information powers, Section 95 penalties, Section 96 wilful evasion, Section 19A personal director liability, GST Act framework, Voluntary Disclosure Programme considerations). Article 157 continues Cross-Border with Australia operations - state-by-state Workers' Compensation (NSW iCare, Victoria WorkSafe, Queensland WorkCover, WA WorkCover), Superannuation Guarantee 11.5% rising to 12% by 1 July 2025, APRA prudential and ASIC conduct framework, Australian Consumer Law, Privacy Act 1988 with Australian Privacy Principles, natural disaster (bushfire / flood / cyclone) underwriting. Articles 158-159 expand Comparison VS with two foundational property cover comparisons: Fire vs PAR claim mechanics (named-perils vs all-risks fundamental architecture, burden of proof differences, specific common operational perils gap analysis, BI interaction) and BI vs CBI worked example (NeoNoodle F&B chain illustration with specific quantification mechanics, named vs non-named supplier scope, indemnity period adequacy, ICOW extensions, common SME underinsurance patterns).
