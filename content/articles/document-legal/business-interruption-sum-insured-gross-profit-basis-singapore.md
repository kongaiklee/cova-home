---
title: "Business Interruption Sum Insured: The Gross-Profit Basis Explained"
slug: "/document-legal/business-interruption-sum-insured-gross-profit-basis-singapore"
...
meta_description: "Singapore insurers rate business interruption on insurable gross profit, not the figure in your accounts. It is turnover minus only the variable costs."
og_title: "Business Interruption Sum Insured: The Gross-Profit Basis Explained"
og_description: "Singapore insurers rate business interruption on insurable gross profit, not the figure in your accounts. It is turnover minus only the variable costs."
---
...
>
> That gap is where SMEs go wrong. They read "gross profit basis", copy the gross profit line from their accounts, and set the BI sum insured far too low. When a fire or flood stops the business, the **average clause** then cuts the payout in proportion to the under-insurance. The same proportional penalty that applies to property cover under [the condition of average](/document-legal/average-clause-underinsurance-singapore) applies to BI, measured against insurable gross profit rather than asset value.
>
...
The formula mirrors the property version set out in detail in [the average clause article](/document-legal/average-clause-underinsurance-singapore):
...
1. **Declaring accounting gross profit as the BI sum insured.** The single most common and most expensive error. The insurance figure is larger because it keeps fixed costs in.

2. **Treating insurable gross profit as net profit.** It is net profit **plus** all the continuing fixed costs, not net profit alone.

3. **Insuring last year's figure for a growing business.** The basis must be projected to the period the cover will respond in.

4. **Choosing a 12-month indemnity period by default.** Recovery to normal trading routinely runs longer than the rebuild.

5. **Forgetting to scale the sum insured to the indemnity period.** A 24-month period needs roughly double the annual gross profit figure.

6. **Assuming average does not apply to BI.** It applies to BI as standard, measured against actual annual gross profit.

7. **Carving wages out without understanding the dual-wages mechanic.** A short wages window can leave retained staff costs unfunded mid-claim.

8. **Confusing the time-excess deductible with the indemnity period.** One sits at the start of the claim, the other caps its length.

9. **Not knowing whether the policy is sum-insured or declaration-linked.** The two behave very differently at claim.

10. **No documentation of how the gross profit figure was built.** Hard to defend the declaration when the loss adjuster recalculates it.

### What This Means for Your Business

1. **Rebuild the figure from turnover, not from your accounts.** Start with turnover, deduct only the named uninsured working expenses, and keep every fixed cost in.

2. **Project forward.** Use the gross profit you expect in the cover year, not the one in last year's audited accounts.

3. **Choose the indemnity period from recovery time, not rebuild time.** Map the realistic path back to normal trading and pick 18, 24 or 36 months if the rebuild-plus-recovery sequence demands it.

4. **Scale the sum insured to that period.** Multiply annual insurable gross profit by the indemnity period in years.

5. **Revalue every renewal.** Treat the BI figure with the same discipline as property values, as flagged in [the average clause guidance](/document-legal/average-clause-underinsurance-singapore).

6. **Check sum-insured versus declaration-linked,** and use the declaration-linked buffer if your turnover is volatile or growing.

7. **Decide the wages basis deliberately,** matching the insured wages window to how long you would actually retain staff through a closure.

8. **Keep the calculation in the policy folder.** A documented build of the gross profit figure is your defence when the adjuster recalculates at claim, as the [BI claim deep-dive](/procedural-howto/bi-claim-deep-dive) shows happens in practice.

### Questions to Ask Your Adviser

1. How is our BI sum insured built, and does it use insurable gross profit (turnover less uninsured working expenses) rather than accounting gross profit?
2. What is our indemnity period, and does it reflect realistic recovery to normal trading, not just the rebuild time?
3. Is the sum insured scaled correctly to that indemnity period?
4. Is our policy on a sum-insured or declaration-linked basis, and what buffer does it carry against growth?
5. How are wages treated, and would retained-staff costs be funded for the full closure?
6. Given our projected gross profit this year, is there any under-insurance that would trigger the average clause at claim?
