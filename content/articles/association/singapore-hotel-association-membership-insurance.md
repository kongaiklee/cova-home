...
**Business interruption.** A fire, flood or major incident does not only damage the building; it stops the rooms earning. Business interruption cover responds to lost revenue and ongoing costs during the period the hotel cannot trade, and it is only as good as the indemnity period and the sum chosen. The mechanics, and the difference from contingent business interruption, are worked through in [Business Interruption vs Contingent Business Interruption](/comparison/bi-vs-cbi-worked-example).
