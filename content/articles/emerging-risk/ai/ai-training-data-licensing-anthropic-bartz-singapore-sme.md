---
title: "AI Training Data Licensing: The Anthropic Bartz Settlement and Singapore SMEs Using Generative AI"
slug: "/emerging-risk/ai/ai-training-data-licensing-anthropic-bartz-singapore-sme"
...
**Professional indemnity (PI).** Where the SME provides professional services and uses AI in the deliverable, PI responds to third-party IP claims subject to policy wording. The same AI-exclusion check applies as for [AI hallucinations in professional services](/emerging-risk/ai/ai-hallucinations-professional-advisory-pi-singapore).
...
1. **Using AI outputs without IP-indemnity tier.** Consumer-tier convenience, enterprise-tier exposure.

2. **Assuming the AI vendor's training data is licensed.** Most providers do not warrant this comprehensively.

3. **No defensive verification** of AI outputs before publication.

4. **For content producers, no documented opt-out** of AI training use.

5. **No PI or Tech E&O wording check** for AI-output-IP exclusions.

6. **Misreading the Copyright Act CDA exception.** The conditions are specific.

7. **Mixing licensed and unlicensed training data** in proprietary AI fine-tuning.

8. **No registered IP for the SME's own content.** Enforcement options are limited.

9. **Vendor contract liability cap too low** to support a meaningful IP indemnity recovery.

10. **No insurance check** on changes to AI vendor stack.

### What This Means for Your Business

1. **If you produce content**: document your IP position, publish machine-readable opt-out signals where applicable, consider licensing arrangements where there is commercial interest.

2. **If you use AI**: confirm you are on an enterprise tier with an IP indemnity, run defensive verification, and check your PI / Tech E&O wording.

3. **For both**: track Copyright Act developments and the major training-data litigation outcomes.

4. **Confirm insurance interaction** with the licensed adviser before deploying any new AI tool or content-licensing arrangement.

5. **Maintain documented audit trails** of AI tool usage, output sources, and verification steps.

6. **Review vendor terms annually** as the indemnity landscape evolves.

7. **Consider media liability or IP infringement cover** if content production is core to the business.

8. **Connect AI procurement to insurance audit** ([the 60-minute audit framework](/procedural-howto/business-insurance-audit-60-minutes-singapore)).

### Questions to Ask Your Adviser

1. For our PI / Tech E&O / media liability wordings, what is the position on AI-output IP infringement claims?
2. If our AI tool's output is alleged to infringe third-party copyright, what is your support model at notification?
3. Have any Singapore-market insurers introduced affirmative AI-IP endorsements that we should consider?
4. For our content licensing position, what is the insurance interaction (representation and warranty cover, IP infringement cover)?
