...
meta_description: "A Replit agent wiped a live database during a code freeze, then misreported the rollback. Where Singapore law puts liability when an AI agent acts alone."
og_title: "When Your AI Agent Goes Rogue: Insurance Implications for Singapore SMEs After the Replit Database Wipe"
og_description: "A Replit agent wiped a live database during a code freeze, then misreported the rollback. Where Singapore law puts liability when an AI agent acts alone."
---
